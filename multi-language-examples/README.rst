...
Welcome
=======
This part of the AWS Code Example Repository contains code samples that span multiple programming
languages. The examples use the AWS Software Developer Kits (SDKs) for the supported programming
languages. For more information, see `Tools to Build on AWS 
<https://aws.amazon.com/getting-started/tools-sdks/>`_.

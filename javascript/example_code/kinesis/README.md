# Kinesis code examples for the SDK for JavaScript (v2)
...
Shows how to use the AWS SDK for JavaScript (v2) to work with Amazon Kinesis.
...
- [SDK for JavaScript (v2) Kinesis reference](https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/Kinesis.html)

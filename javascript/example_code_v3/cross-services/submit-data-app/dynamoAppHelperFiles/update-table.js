...
Purpose:
update-table.js is part of a tutorial demonstrating how to build and deploy and app to submit
data to a DynamoDB table. update-table.js demonstrates how to update a DynamoDB table.

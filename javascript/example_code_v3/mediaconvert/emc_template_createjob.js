...
- TEMPLATE_NAME
- ROLE_ARN
- FILE_INPUT (e.g., https://BUCKET_NAME.s3-REGION.amazonaws.com/FILE_NAME)
    ...
    "Inputs": [
      {
        ...
        "FileInput": process.argv[6] //e.g., https://BUCKET_NAME.s3-REGION.amazonaws.com/FILE_NAME
      }
    ]
  }
};

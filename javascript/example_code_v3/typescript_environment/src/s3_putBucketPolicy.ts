...
Purpose:
s3_putBucketPolicy.ts is an example that demonstrates the use of the typescript_enviornment provided for
experimenting with Node.js AWS SDK code examples.

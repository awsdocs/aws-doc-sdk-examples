...
## Purpose
The code examples in this directory demonstrate how to work with the Amazon Neptune 
...
### API examples
- [Create a database cluster](./create_db_cluster.cpp) (CreateDBCluster)
- [Delete a database cluster](./delete_db_cluster.cpp) (DeleteDBCluster)
- [Describe your database clusters](./describe_db_clusters.cpp) (DescribeDBClusters)
- [Modify a database cluster](./modify_db_cluster.cpp) (ModifyDBCluster)
...
To run these code examples, your AWS user must have permissions to perform these actions with Amazon Neptune.  
The AWS managed policy named "NeptuneFullAccess" may be used to bulk-grant the necessary permissions.  

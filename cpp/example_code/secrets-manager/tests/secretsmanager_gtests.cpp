...
#include "secretsmanager_gtests.h"
#include <fstream>
#include <aws/core/client/ClientConfiguration.h>

Aws::SDKOptions AwsDocTest::SecretsManager_GTests::s_options;
std::unique_ptr<Aws::Client::ClientConfiguration> AwsDocTest::SecretsManager_GTests::s_clientConfig;
...
void AwsDocTest::SecretsManager_GTests::SetUpTestSuite() {
    InitAPI(s_options);
...
void AwsDocTest::SecretsManager_GTests::TearDownTestSuite() {
    ShutdownAPI(s_options);

}

void AwsDocTest::SecretsManager_GTests::SetUp() {
    if (suppressStdOut()) {
...
void AwsDocTest::SecretsManager_GTests::TearDown() {
...
Aws::String AwsDocTest::SecretsManager_GTests::preconditionError() {
    return "Failed to meet precondition.";
}

void AwsDocTest::SecretsManager_GTests::AddCommandLineResponses(
...
bool AwsDocTest::SecretsManager_GTests::suppressStdOut() {

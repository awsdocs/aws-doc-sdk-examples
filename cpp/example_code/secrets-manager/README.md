...
Shows how to use the AWS SDK for C++ to work with AWS Secrets Manager.
...
- [GetSecretValue](get_secret_value.cpp#L21)
...
- [SDK for C++ Secrets Manager reference](https://sdk.amazonaws.com/cpp/api/LATEST/aws-cpp-sdk-secrets-manager/html/annotated.html)

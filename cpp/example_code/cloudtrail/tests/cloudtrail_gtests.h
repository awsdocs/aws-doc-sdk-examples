...
#pragma once
#ifndef CLOUDTRAIL_EXAMPLES_CLOUDTRAIL_GTESTS_H
#define CLOUDTRAIL_EXAMPLES_CLOUDTRAIL_GTESTS_H
...
namespace AwsDocTest {
    ...
    class CloudTrail_GTests : public testing::Test {
    protected:
...
#endif //CLOUDTRAIL_EXAMPLES_CLOUDTRAIL_GTESTS_H

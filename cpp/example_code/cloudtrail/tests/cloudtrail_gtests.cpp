...
Aws::SDKOptions AwsDocTest::CloudTrail_GTests::s_options;
std::unique_ptr<Aws::Client::ClientConfiguration> AwsDocTest::CloudTrail_GTests::s_clientConfig;
static const char ALLOCATION_TAG[] = "CloudTrail_GTEST";
...
void AwsDocTest::CloudTrail_GTests::SetUpTestSuite() {
    InitAPI(s_options);
...
void AwsDocTest::CloudTrail_GTests::TearDownTestSuite() {
    ShutdownAPI(s_options);

}

void AwsDocTest::CloudTrail_GTests::SetUp() {
    if (suppressStdOut()) {
...
void AwsDocTest::CloudTrail_GTests::TearDown() {
...
Aws::String AwsDocTest::CloudTrail_GTests::preconditionError() {
    return "Failed to meet precondition.";
}

void AwsDocTest::CloudTrail_GTests::AddCommandLineResponses(
...
bool AwsDocTest::CloudTrail_GTests::suppressStdOut() {

# Amazon S3 encryption C++ SDK code examples

## Purpose
The code examples in this directory demonstrate how to manage Amazon Simple Storage Service (Amazon S3) encryption 
...
### API examples
- [Manage Amazon S3 encryption](./s3Encryption.cpp) 

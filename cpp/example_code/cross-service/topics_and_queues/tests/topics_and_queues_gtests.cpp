...
namespace AwsDocTest {
    static const char ALLOCATION_TAG[] = "TOPICS_AND_QUEUES_GTEST";
    Aws::SDKOptions TopicsAndQueues_GTests::s_options;
...
void AwsDocTest::TopicsAndQueues_GTests::TearDownTestSuite() {

    ShutdownAPI(s_options);
}

void AwsDocTest::TopicsAndQueues_GTests::SetUp() {
    if (suppressStdOut()) {
...
void AwsDocTest::TopicsAndQueues_GTests::TearDown() {
...
void AwsDocTest::TopicsAndQueues_GTests::AddCommandLineResponses(
...
bool AwsDocTest::TopicsAndQueues_GTests::suppressStdOut() {

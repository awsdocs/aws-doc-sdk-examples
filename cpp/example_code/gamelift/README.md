# Amazon GameLift C++ SDK code examples

## Purpose
The code examples in this directory demonstrate how to work with the Amazon GameLift 
using the AWS SDK for C++.

GameLift provides solutions for hosting session-based multiplayer game servers in the cloud, including a 
fully managed service for deploying, operating, and scaling game servers. Built on AWS global computing 
...
### API examples
- [Makes game server processes go active](./GameLift-Unreal-game-server.cpp) 
...
To run these code examples, your AWS user must have permissions to perform these actions with Amazon GameLift.  
The AWS managed policy named "GameLiftGameServerGroupPolicy" may be used to bulk-grant the necessary permissions.  

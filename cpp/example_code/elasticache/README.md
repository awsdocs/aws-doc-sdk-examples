# Amazon ElastiCache C++ SDK code examples

## Purpose
The code examples in this directory demonstrate how to work with the Amazon ElastiCache 
...
### API examples
- [Add tags to a resource](./add_tags_to_resource.cpp) (AddTagsToResource)
- [Create a cache cluster](./create_cache_cluster.cpp) (CreateCacheCluster)
- [Delete a cache cluster](./delete_cache_cluster.cpp) (DeleteCacheCluster)
- [Modify a cache cluster](./modify_cache_cluster.cpp) (ModifyCacheCluster)
...
To run these code examples, your AWS user must have permissions to perform these actions with Amazon ElastiCache.  
The AWS managed policy named "AmazonElastiCacheFullAccess" may be used to bulk-grant the necessary permissions.  

...
static const char ALLOCATION_TAG[] = "IoT_GTEST";
...
Aws::SDKOptions AwsDocTest::IoT_GTests::s_options;
std::unique_ptr<Aws::Client::ClientConfiguration> AwsDocTest::IoT_GTests::s_clientConfig;

void AwsDocTest::IoT_GTests::SetUpTestSuite() {
    InitAPI(s_options);
...
void AwsDocTest::IoT_GTests::TearDownTestSuite() {
    ShutdownAPI(s_options);

}

void AwsDocTest::IoT_GTests::SetUp() {
    if (suppressStdOut()) {
...
void AwsDocTest::IoT_GTests::TearDown() {
...
Aws::String AwsDocTest::IoT_GTests::preconditionError() {
    return "Failed to meet precondition.";
}

void AwsDocTest::IoT_GTests::AddCommandLineResponses(
...
bool AwsDocTest::IoT_GTests::suppressStdOut() {

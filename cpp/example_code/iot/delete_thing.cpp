...
// snippet-start:[cpp.example_code.iot.DeleteThing]
...
// snippet-end:[cpp.example_code.iot.DeleteThing]

/*
 *
 *  main function
 *
 *  Usage: 'run_delete_thing <thing_name>'
 *
 */
...
int main(int argc, char **argv) {
    if (argc != 2) {
        std::cout << "Usage: run_delete_thing <thing_name>" << std::endl;
        return 1;
    }
    ...
    Aws::InitAPI(options);
    {
        ...
        AwsDoc::IoT::deleteThing(thingName, clientConfig);
    }

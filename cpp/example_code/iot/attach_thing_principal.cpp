...
// snippet-start:[cpp.example_code.iot.AttachThingPrincipal]
...
// snippet-end:[cpp.example_code.iot.AttachThingPrincipal]

/*
 *
 *  main function
 *
 *  Usage: 'run_attach_thing_principal <principal> <thing_name>'
 *
 */
...
int main(int argc, char **argv) {
    if (argc != 3) {
        std::cout << "Usage: run_attach_thing_principal <principal> <thing_name>"
                  << std::endl;
        return 1;
    }
    ...
    Aws::InitAPI(options);
    {
        ...
        AwsDoc::IoT::attachThingPrincipal(principal, thingName, clientConfig);
    }

...
Aws::SDKOptions AwsDocTest::ACM_GTests::s_options;
std::unique_ptr<Aws::Client::ClientConfiguration> AwsDocTest::ACM_GTests::s_clientConfig;
static const char ALLOCATION_TAG[] = "ACM_GTEST";
...
void AwsDocTest::ACM_GTests::SetUpTestSuite() {
    InitAPI(s_options);
...
void AwsDocTest::ACM_GTests::SetUp() {
    if (suppressStdOut()) {
...
void AwsDocTest::ACM_GTests::TearDown() {
...
Aws::String AwsDocTest::ACM_GTests::preconditionError() {
    return "Failed to meet precondition.";
}

void AwsDocTest::ACM_GTests::AddCommandLineResponses(
...
bool AwsDocTest::ACM_GTests::suppressStdOut() {

# Hello DynamoDB for the SDK for C++

## Overview

This folder provides a CMake "Hello DynamoDB" project that uses the AWS SDK for C++ to call Amazon DynamoDB (DynamoDB).
...
The built executable is named `hello_dynamodb`.

You can run this example with the AWS managed policy "arn:aws:iam::aws:policy/AmazonDynamoDBReadOnlyAccess".
...
The [hello_dynamodb.cpp](hello_dynamodb.cpp) file contains the C++ source code, including a "main" function.
...
* [DynamoDB C++ API Reference](https://sdk.amazonaws.com/cpp/api/LATEST/aws-cpp-sdk-dynamodb/html/annotated.html)

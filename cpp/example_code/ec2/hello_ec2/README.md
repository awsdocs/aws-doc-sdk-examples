# Hello EC2 for the SDK for C++

## Overview

This folder provides a CMake "Hello EC2" project that uses the AWS SDK for C++ to call Amazon Elastic Compute Cloud (Amazon EC2).
...
The [hello_ec2.cpp](hello_ec2.cpp) file contains the C++ source code, including a "main" function.
...
* [Amazon EC2 C++ APIs](https://sdk.amazonaws.com/cpp/api/LATEST/aws-cpp-sdk-ec2/html/annotated.html)

...
namespace AwsDocTest {
        ...
        AddCommandLineResponses({"1",  // Choose from one of the following checksum algorithms
                                 "y",  // Let the SDK calculate the checksum for you? (y/n)
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
                                 "n" // Would you like to repeat with a different checksum algorithm? Answer 'y' or 'n'.
});
    ...
    TEST_F(S3_GTests, s3_object_integrity_workflow_MD5_sdk_checksum_2_ ) {
        AddCommandLineResponses({"2",  // Choose from one of the following checksum algorithms
                                 "y",  // Let the SDK calculate the checksum for you? (y/n)
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
    ...
    TEST_F(S3_GTests, s3_object_integrity_workflow_CRC32_sdk_checksum_2_ ) {
        AddCommandLineResponses({"3",  // Choose from one of the following checksum algorithms
                                 "y",  // Let the SDK calculate the checksum for you? (y/n)
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
    ...
    TEST_F(S3_GTests, s3_object_integrity_workflow_CRC32C_sdk_checksum_2_ ) {
        AddCommandLineResponses({"4",  // Choose from one of the following checksum algorithms
                                 "y",  // Let the SDK calculate the checksum for you? (y/n)
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
    ...
    TEST_F(S3_GTests, s3_object_integrity_workflow_SHA1_sdk_checksum_2_ ) {
        AddCommandLineResponses({"5",  // Choose from one of the following checksum algorithms
                                 "y",  // Let the SDK calculate the checksum for you? (y/n)
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
    ...
    TEST_F(S3_GTests, s3_object_integrity_workflow_SHA256_sdk_checksum_2_ ) {
        AddCommandLineResponses({"6",  // Choose from one of the following checksum algorithms
                                 "y",  // Let the SDK calculate the checksum for you? (y/n)
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...
                                 "",   // Press Enter to continue...

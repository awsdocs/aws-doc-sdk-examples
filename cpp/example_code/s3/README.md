...
- [Delete a bucket policy (permission to access resources) of an S3 bucket](./delete_bucket_policy.cpp) (DeleteBucketPolicy)
...
- [Get the access control list (ACL) for an S3 bucket](./get_acl.cpp) (GetBucketAcl)
...
- [Get and set the access control list (ACL) for an object in an S3 bucket](./get_put_object_acl.cpp) (GetObjectAcl, PutObjectAcl)
- [Get the configuration of an S3 bucket configured for static website hosting](./get_website_config.cpp) (GetBucketWebsite)
- [List all S3 buckets](./list_buckets.cpp) (GetBuckets)
- [List all objects in an S3 bucket](./list_objects.cpp) (ListObjects)
- [Make requests to S3 across AWS Regions by specifying aws-global as the AWS Region](./list_objects_with_aws_global_region.cpp)
...
- [Upload an object to an S3 bucket (using a memory buffer instead of local disk copy)](./put_object_buffer.cpp) (PutObject)
...
- [Find, create, and delete an S3 bucket in a sequence](./s3-demo.cpp)

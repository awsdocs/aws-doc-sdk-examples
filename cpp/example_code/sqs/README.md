<!--Generated by WRITEME on 2023-05-03 16:58:45.391269 (UTC)-->
...
* [Change how long a queue waits for a message](set_queue_attributes.cpp#L23) (`setQueueAttributes`)
...
* [Create a queue](create_queue.cpp#L26) (`createQueue`)
* [Delete a message from a queue](delete_message.cpp#L25) (`deleteMessage`)
* [Delete a queue](delete_queue.cpp#L26) (`deleteQueue`)
* [Get the URL of a queue](get_queue_url.cpp#L26) (`GetQueueUrl`)
* [List queues](list_queues.cpp#L26) (`listQueues`)
* [Receive messages from a queue](receive_message.cpp#L25) (`receiveMessage`)
* [Send a message to a queue](send_message.cpp#L26) (`sendMessage`)

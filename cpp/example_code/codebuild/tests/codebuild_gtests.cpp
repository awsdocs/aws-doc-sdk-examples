...
Aws::SDKOptions AwsDocTest::CodeBuild_GTests::s_options;
std::unique_ptr<Aws::Client::ClientConfiguration> AwsDocTest::CodeBuild_GTests::s_clientConfig;
static const char ALLOCATION_TAG[] = "CodeBuild_GTEST";
...
void AwsDocTest::CodeBuild_GTests::TearDownTestSuite() {
    ShutdownAPI(s_options);

}

void AwsDocTest::CodeBuild_GTests::SetUp() {
    if (suppressStdOut()) {
...
void AwsDocTest::CodeBuild_GTests::TearDown() {
...
Aws::String AwsDocTest::CodeBuild_GTests::preconditionError() {
    return "Failed to meet precondition.";
}

void AwsDocTest::CodeBuild_GTests::AddCommandLineResponses(
...
bool AwsDocTest::CodeBuild_GTests::suppressStdOut() {

...
#pragma once
#ifndef CODEBUILD_EXAMPLES_CODEBUILD_GTESTS_H
#define CODEBUILD_EXAMPLES_CODEBUILD_GTESTS_H
...
namespace AwsDocTest {
    ...
    class CodeBuild_GTests : public testing::Test {
    protected:
...
#endif //CODEBUILD_EXAMPLES_CODEBUILD_GTESTS_H

# Amazon GuardDuty C++ SDK code examples
...
### API examples
- [List detectors](./list_detectors.cpp) (ListDetectors)
- [List findings](./list_findings_with_finding_criteria.cpp) (ListFindings)
...
To run these code examples, your AWS user must have permissions to perform these actions with Amazon GuardDuty.  
The AWS managed policy named "AmazonGuardDutyFullAccess" may be used to bulk-grant the necessary permissions.  

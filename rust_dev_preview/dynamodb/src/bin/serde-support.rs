...
#[cfg(not(all(aws_sdk_unstable, all(feature="serde-serialize", feature="serde-deserialize"))))]
fn main() {
    println!("serde features are not enabled!")
}

#[cfg(all(aws_sdk_unstable, all(feature="serde-serialize", feature="serde-deserialize")))]
fn main() {

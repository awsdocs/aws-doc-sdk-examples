...
```
ECR: 801093629784.dkr.ecr.us-east-1.amazonaws.com/
...
docker pull 801093629784.dkr.ecr.us-east-1.amazonaws.com/sdk-examples-python:latest

# 3. Run tests (unit tests — no AWS creds needed)
docker run --rm \
  -v /workspace/aws-doc-sdk-examples:/repo:ro \
  801093629784.dkr.ecr.us-east-1.amazonaws.com/sdk-examples-python:latest \

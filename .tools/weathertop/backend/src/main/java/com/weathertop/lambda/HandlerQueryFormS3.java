...
public class HandlerQueryFormS3 implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent event, Context context) {
        ...
        try {
            ...
            QueryLatestFromS3 fetcher = new QueryLatestFromS3();
            String json = fetcher.readJsonFromS3(language);

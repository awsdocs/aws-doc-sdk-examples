...
// snippet-start:[Lambda.dotnetv4.LambdaActions.LambdaWrapper]
...
public class LambdaWrapper
{
    ...
    // snippet-start:[Lambda.dotnetv4.LambdaActions.CreateLambdaFunction]
    /// <summary>
    ...
    // snippet-end:[Lambda.dotnetv4.LambdaActions.CreateLambdaFunction]

    // snippet-start:[Lambda.dotnetv4.LambdaActions.DeleteLambdaFunction]
    /// <summary>
    ...
    // snippet-end:[Lambda.dotnetv4.LambdaActions.DeleteLambdaFunction]

    // snippet-start:[Lambda.dotnetv4.LambdaActions.GetFunction]
    /// <summary>
    ...
    // snippet-end:[Lambda.dotnetv4.LambdaActions.GetFunction]

    // snippet-start:[Lambda.dotnetv4.LambdaActions.InvokeFunction]
    /// <summary>
    ...
    // snippet-end:[Lambda.dotnetv4.LambdaActions.InvokeFunction]

    // snippet-start:[Lambda.dotnetv4.LambdaActions.ListFunctions]
    /// <summary>
    ...
    // snippet-end:[Lambda.dotnetv4.LambdaActions.ListFunctions]

    // snippet-start:[Lambda.dotnetv4.LambdaActions.UpdateFunctionCode]
    /// <summary>
    ...
    // snippet-end:[Lambda.dotnetv4.LambdaActions.UpdateFunctionCode]

    // snippet-start:[Lambda.dotnetv4.LambdaActions.UpdateFunctionConfiguration]
    /// <summary>
    ...
    // snippet-end:[Lambda.dotnetv4.LambdaActions.UpdateFunctionConfiguration]

}

// snippet-end:[Lambda.dotnetv4.LambdaActions.LambdaWrapper]
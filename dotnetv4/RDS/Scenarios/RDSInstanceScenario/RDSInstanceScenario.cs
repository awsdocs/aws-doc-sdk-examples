...
// snippet-start:[RDS.dotnetv4.RdsInstanceScenario]
...
public class RDSInstanceScenario
{
    ...
    */
        ...
        string engineName, string engineVersion, string instanceClass, string instanceIdentifier)
    {
        ...
        isInstanceReady = instances.Find(i =>
    ...
    public static async Task DeleteRdsInstance(DBInstance newInstance)
    {
        ...
        while (!isInstanceDeleted)
        {
            ...
            isInstanceDeleted = instance.TrueForAll(i => i.DBInstanceIdentifier != newInstance.DBInstanceIdentifier);
            Thread.Sleep(30000);
        }
    ...
    // snippet-end:[RDS.dotnetv4.RdsInstanceScenario]
}
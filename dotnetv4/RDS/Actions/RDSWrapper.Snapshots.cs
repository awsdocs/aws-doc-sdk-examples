...
// snippet-start:[RDS.dotnetv4.RdsInstanceWrapperSnapshots]
...
{
    // snippet-start:[RDS.dotnetv4.CreateDBSnapshot]
    ...
    // snippet-end:[RDS.dotnetv4.CreateDBSnapshot]

    // snippet-start:[RDS.dotnetv4.DescribeDBSnapshots]
    ...
    // snippet-end:[RDS.dotnetv4.DescribeDBSnapshots]
    // snippet-end:[RDS.dotnetv4.RdsInstanceWrapperSnapshots]
}
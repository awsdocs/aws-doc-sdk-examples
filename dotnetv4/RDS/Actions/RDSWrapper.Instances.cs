...
// snippet-start:[RDS.dotnetv4.RdsInstanceWrapper]
...
public partial class RDSWrapper
{
    ...
    // snippet-start:[RDS.dotnetv4.DescribeDBEngineVersions]
    ...
    // snippet-end:[RDS.dotnetv4.DescribeDBEngineVersions]

    // snippet-start:[RDS.dotnetv4.DescribeOrderableDBInstanceOptions]
    ...
    // snippet-end:[RDS.dotnetv4.DescribeOrderableDBInstanceOptions]

    // snippet-start:[RDS.dotnetv4.DescribeDbInstances]
    ...
    // snippet-end:[RDS.dotnetv4.DescribeDbInstances]

    // snippet-start:[RDS.dotnetv4.CreateDBInstance]
    ...
    // snippet-end:[RDS.dotnetv4.CreateDBInstance]

    // snippet-start:[RDS.dotnetv4.DeleteDBInstance]
    ...
    // snippet-end:[RDS.dotnetv4.DeleteDBInstance]
    // snippet-end:[RDS.dotnetv4.RdsInstanceWrapper]

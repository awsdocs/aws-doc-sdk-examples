...
// snippet-start:[RDS.dotnetv4.RdsInstanceWrapperParameterGroups]
...
{
    // snippet-start:[RDS.dotnetv4.DescribeDBParameterGroups]
    ...
    // snippet-end:[RDS.dotnetv4.DescribeDBParameterGroups]

    // snippet-start:[RDS.dotnetv4.CreateDBParameterGroup]
    ...
    // snippet-end:[RDS.dotnetv4.CreateDBParameterGroup]

    // snippet-start:[RDS.dotnetv4.ModifyDBParameterGroup]
    ...
    // snippet-end:[RDS.dotnetv4.ModifyDBParameterGroup]

    // snippet-start:[RDS.dotnetv4.DeleteDBParameterGroup]
    ...
    // snippet-end:[RDS.dotnetv4.DeleteDBParameterGroup]

    // snippet-start:[RDS.dotnetv4.DescribeDBParameters]
    ...
    // snippet-end:[RDS.dotnetv4.DescribeDBParameters]
    // snippet-end:[RDS.dotnetv4.RdsInstanceWrapperParameterGroups]

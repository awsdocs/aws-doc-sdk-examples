...
// snippet-start:[TopicsAndQueues.dotnetv4.SNSWrapper]
...
public class SNSWrapper
{
    ...
    // snippet-start:[TopicsAndQueues.dotnetv4.CreateTopic]
    /// <summary>
    ...
    // snippet-end:[TopicsAndQueues.dotnetv4.CreateTopic]

    // snippet-start:[TopicsAndQueues.dotnetv4.Subscribe]
    /// <summary>
    ...
    // snippet-end:[TopicsAndQueues.dotnetv4.Subscribe]

    // snippet-start:[TopicsAndQueues.dotnetv4.Publish]
    /// <summary>
    ...
    // snippet-end:[TopicsAndQueues.dotnetv4.Publish]


    // snippet-start:[TopicsAndQueues.dotnetv4.Unsubscribe]
    /// <summary>
    ...
    // snippet-end:[TopicsAndQueues.dotnetv4.Unsubscribe]

    // snippet-start:[TopicsAndQueues.dotnetv4.DeleteTopic]
    /// <summary>
    ...
    // snippet-end:[TopicsAndQueues.dotnetv4.DeleteTopic]
}
// snippet-end:[TopicsAndQueues.dotnetv4.SNSWrapper]
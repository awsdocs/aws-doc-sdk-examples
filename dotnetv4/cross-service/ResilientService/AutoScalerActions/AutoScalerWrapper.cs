...
// snippet-start:[ResilientService.dotnetv4.AutoScalerWrapper]
/// <summary>
...
public class AutoScalerWrapper
{
    ...
    // snippet-start:[ResilientService.dotnetv4.iam.CreateInstanceProfile]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.iam.CreateInstanceProfile]

    // snippet-start:[ResilientService.dotnetv4.ec2.CreateKeyPair]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.ec2.CreateKeyPair]

    // snippet-start:[ResilientService.dotnetv4.ec2.DeleteKeyPair]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.ec2.DeleteKeyPair]

    // snippet-start:[ResilientService.dotnetv4.ec2.CreateLaunchTemplate]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.ec2.CreateLaunchTemplate]

    // snippet-start:[ResilientService.dotnetv4.Ec2.DescribeAvailabilityZones]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.Ec2.DescribeAvailabilityZones]

    // snippet-start:[ResilientService.dotnetv4.Ec2.CreateGroup]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.Ec2.CreateGroup]

    // snippet-start:[ResilientService.dotnetv4.Ec2.DescribeVpcs]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.Ec2.DescribeVpcs]

    // snippet-start:[ResilientService.dotnetv4.Ec2.DescribeSubnets]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.Ec2.DescribeSubnets]

    // snippet-start:[ResilientService.dotnetv4.Ec2.DeleteLaunchTemplate]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.Ec2.DeleteLaunchTemplate]

    // snippet-start:[ResilientService.dotnetv4.iam.DeleteInstanceProfile]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.iam.DeleteInstanceProfile]

    // snippet-start:[ResilientService.dotnetv4.AutoScaling.DescribeAutoScalingGroups]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.AutoScaling.DescribeAutoScalingGroups]

    // snippet-start:[ResilientService.dotnetv4.Ec2.GetInstanceProfile]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.Ec2.GetInstanceProfile]

    // snippet-start:[ResilientService.dotnetv4.Ec2.ReplaceInstanceProfile]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.Ec2.ReplaceInstanceProfile]

    // snippet-start:[ResilientService.dotnetv4.AutoScaling.DeleteAutoScalingGroup]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.AutoScaling.DeleteAutoScalingGroup]

    // snippet-start:[ResilientService.dotnetv4.Ec2.DescribeSecurityGroups]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.Ec2.DescribeSecurityGroups]

    // snippet-start:[ResilientService.dotnetv4.Ec2.AuthorizeSecurityGroupIngress]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.Ec2.AuthorizeSecurityGroupIngress]

    // snippet-start:[ResilientService.dotnetv4.AutoScaling.AttachLoadBalancer]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.AutoScaling.AttachLoadBalancer]
...
// snippet-end:[ResilientService.dotnetv4.AutoScalerWrapper]
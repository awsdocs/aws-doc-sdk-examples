...
// snippet-start:[ResilientService.dotnetv4.ELB.ElasticLoadBalancerWrapper]
/// <summary>
...
public class ElasticLoadBalancerWrapper
{
    ...
    // snippet-start:[ResilientService.dotnetv4.ELB.DescribeLoadBalancers]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.ELB.DescribeLoadBalancers]
    ...
    // snippet-start:[ResilientService.dotnetv4.ELB.DescribeTargetHealth]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.ELB.DescribeTargetHealth]

    // snippet-start:[ResilientService.dotnetv4.ELB.CreateTargetGroup]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.ELB.CreateTargetGroup]

    // snippet-start:[ResilientService.dotnetv4.ELB.CreateLoadBalancer]
    // snippet-start:[ResilientService.dotnetv4.ELB.CreateListener]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.ELB.CreateLoadBalancer]
    // snippet-end:[ResilientService.dotnetv4.ELB.CreateListener]
    ...
    // snippet-start:[ResilientService.dotnetv4.ELB.DeleteLoadBalancer]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.ELB.DeleteLoadBalancer]

    // snippet-start:[ResilientService.dotnetv4.ELB.DeleteTargetGroup]
    /// <summary>
    ...
    // snippet-end:[ResilientService.dotnetv4.ELB.DeleteTargetGroup]
}
// snippet-end:[ResilientService.dotnetv4.ELB.ElasticLoadBalancerWrapper]
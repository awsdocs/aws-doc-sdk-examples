...
// snippet-start:[SageMaker.dotnetv4.HelloSageMaker]
...
public static class HelloSageMaker
{
    static async Task Main(string[] args)
    {
        ...
        foreach (var notebookInstance in response.NotebookInstances)
        {
            ...
            Console.WriteLine($"\tCreation Date: {notebookInstance.CreationTime.GetValueOrDefault().ToShortDateString()}");
            Console.WriteLine();
        }
    }
}
// snippet-end:[SageMaker.dotnetv4.HelloSageMaker]
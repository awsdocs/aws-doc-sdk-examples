...
namespace ManageTopicSubscriptionExample
{
    ...
    public class ManageTopicSubscription
    {
        ...
        // snippet-start:[SNS.dotnetv4.TopicSubscribe]
        ...
        // snippet-end:[SNS.dotnetv4.TopicSubscribe]

        // snippet-start:[SNS.dotnetv4.UnsubscribeTopic]
    ...
    // snippet-end:[SNS.dotnetv4.UnsubscribeTopic]
}
...
{
    // snippet-start:[SNS.dotnetv4.CheckIfOptedOut]
    using System;
    ...
    public class IsPhoneNumOptedOut
    {
        ...
        public static async Task CheckIfOptedOutAsync(IAmazonSimpleNotificationService client, string phoneNumber)
        {
            ...
            try
            {
                ...
                {
                    string optOutStatus = (bool)response.IsOptedOut ? "opted out" : "not opted out.";
    ...
    // snippet-end:[SNS.dotnetv4.CheckIfOptedOut]
}
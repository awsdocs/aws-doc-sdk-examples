...
// snippet-start:[Support.dotnetv4.SupportWrapper]
...
public class SupportWrapper
{
    ...
    // snippet-start:[Support.dotnetv4.DescribeServices]
    ...
    // snippet-end:[Support.dotnetv4.DescribeServices]

    // snippet-start:[Support.dotnetv4.DescribeSeverityLevels]
    ...
    // snippet-end:[Support.dotnetv4.DescribeSeverityLevels]

    // snippet-start:[Support.dotnetv4.CreateCase]
    ...
    // snippet-end:[Support.dotnetv4.CreateCase]

    // snippet-start:[Support.dotnetv4.AddAttachmentToSet]
    ...
    // snippet-end:[Support.dotnetv4.AddAttachmentToSet]

    // snippet-start:[Support.dotnetv4.DescribeAttachment]
    ...
    // snippet-end:[Support.dotnetv4.DescribeAttachment]

    // snippet-start:[Support.dotnetv4.AddCommunicationToCase]
        ...
        string? attachmentSetId = null, List<string>? ccEmailAddresses = null)
    {
        ...
        return response.Result.GetValueOrDefault();
    }

    // snippet-end:[Support.dotnetv4.AddCommunicationToCase]

    // snippet-start:[Support.dotnetv4.DescribeCommunications]
    ...
    // snippet-end:[Support.dotnetv4.DescribeCommunications]

    // snippet-start:[Support.dotnetv4.DescribeCases]
    ...
    // snippet-end:[Support.dotnetv4.DescribeCases]

    // snippet-start:[Support.dotnetv4.ResolveCase]
    ...
    // snippet-end:[Support.dotnetv4.ResolveCase]
...
// snippet-end:[Support.dotnetv4.SupportWrapper]
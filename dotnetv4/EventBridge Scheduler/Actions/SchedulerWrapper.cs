...
// snippet-start:[Scheduler.dotnetv4.SchedulerWrapper]
...
public class SchedulerWrapper
{
    ...
    // snippet-start:[Scheduler.dotnetv4.CreateSchedule]
    /// <summary>
    ...
    // snippet-end:[Scheduler.dotnetv4.CreateSchedule]

    // snippet-start:[Scheduler.dotnetv4.CreateScheduleGroup]
    /// <summary>
    ...
    // snippet-end:[Scheduler.dotnetv4.CreateScheduleGroup]

    // snippet-start:[Scheduler.dotnetv4.DeleteSchedule]
    /// <summary>
    ...
    // snippet-end:[Scheduler.dotnetv4.DeleteSchedule]

    // snippet-start:[Scheduler.dotnetv4.DeleteScheduleGroup]
    /// <summary>
    ...
    // snippet-end:[Scheduler.dotnetv4.DeleteScheduleGroup]
}
// snippet-end:[Scheduler.dotnetv4.SchedulerWrapper]
...
// snippet-start:[CloudWatch.dotnetv4.CloudWatchWrapper]
/// <summary>
...
public class CloudWatchWrapper
{
    ...
    // snippet-start:[CloudWatch.dotnetv4.ListMetrics]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.ListMetrics]

    // snippet-start:[CloudWatch.dotnetv4.GetMetricStatistics]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.GetMetricStatistics]

    // snippet-start:[CloudWatch.dotnetv4.PutDashboard]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.PutDashboard]

    // snippet-start:[CloudWatch.dotnetv4.GetDashboard]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.GetDashboard]

    // snippet-start:[CloudWatch.dotnetv4.ListDashboards]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.ListDashboards]

    // snippet-start:[CloudWatch.dotnetv4.PutMetricData]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.PutMetricData]

    // snippet-start:[CloudWatch.dotnetv4.GetMetricImage]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.GetMetricImage]

    // snippet-start:[CloudWatch.dotnetv4.GetMetricData]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.GetMetricData]

    // snippet-start:[CloudWatch.dotnetv4.PutMetricAlarm]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.PutMetricAlarm]

    // snippet-start:[CloudWatch.dotnetv4.DescribeAlarms]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.DescribeAlarms]

    // snippet-start:[CloudWatch.dotnetv4.DescribeAlarmsForMetric]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.DescribeAlarmsForMetric]

    // snippet-start:[CloudWatch.dotnetv4.DescribeAlarmHistory]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.DescribeAlarmHistory]

    // snippet-start:[CloudWatch.dotnetv4.DeleteAlarms]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.DeleteAlarms]

    // snippet-start:[CloudWatch.dotnetv4.DisableAlarmActions]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.DisableAlarmActions]

    // snippet-start:[CloudWatch.dotnetv4.EnableAlarmActions]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.EnableAlarmActions]

    // snippet-start:[CloudWatch.dotnetv4.PutAnomalyDetector]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.PutAnomalyDetector]

    // snippet-start:[CloudWatch.dotnetv4.DescribeAnomalyDetectors]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.DescribeAnomalyDetectors]

    // snippet-start:[CloudWatch.dotnetv4.DeleteAnomalyDetector]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.DeleteAnomalyDetector]

    // snippet-start:[CloudWatch.dotnetv4.DeleteDashboards]
    /// <summary>
    ...
    // snippet-end:[CloudWatch.dotnetv4.DeleteDashboards]
}
// snippet-end:[CloudWatch.dotnetv4.CloudWatchWrapper]
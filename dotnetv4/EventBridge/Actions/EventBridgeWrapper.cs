...
// snippet-start:[EventBridge.dotnetv4.EventBridgeWrapper]
...
public class EventBridgeWrapper
{
    ...
    // snippet-start:[EventBridge.dotnetv4.DescribeRule]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.DescribeRule]

    // snippet-start:[EventBridge.dotnetv4.EnableRule]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.EnableRule]

    // snippet-start:[EventBridge.dotnetv4.DisableRule]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.DisableRule]

    // snippet-start:[EventBridge.dotnetv4.ListRules]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.ListRules]

    // snippet-start:[EventBridge.dotnetv4.ListTargetsByRule]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.ListTargetsByRule]

    // snippet-start:[EventBridge.dotnetv4.ListRuleNamesByTarget]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.ListRuleNamesByTarget]

    // snippet-start:[EventBridge.dotnetv4.PutRule]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.PutRule]

    // snippet-start:[EventBridge.dotnetv4.PutTargetsTransform]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.PutTargetsTransform]

    // snippet-start:[EventBridge.dotnetv4.PutCustomTransform]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.PutCustomTransform]

    // snippet-start:[EventBridge.dotnetv4.PutEvents]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.PutEvents]

    // snippet-start:[EventBridge.dotnetv4.PutCustomRulePattern]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.PutCustomRulePattern]

    // snippet-start:[EventBridge.dotnetv4.PutSnsTarget]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.PutSnsTarget]

    // snippet-start:[EventBridge.dotnetv4.RemoveTargets]
    /// <summary>
    ...
    // snippet-end:[EventBridge.dotnetv4.RemoveTargets]

    // snippet-start:[EventBridge.dotnetv4.DeleteRule]
    /// <summary>
    /// Delete an event rule by name.
    /// </summary>
    /// <param name="ruleName">The name of the event rule.</param>
    ...
    // snippet-end:[EventBridge.dotnetv4.DeleteRule]
}
// snippet-end:[EventBridge.dotnetv4.EventBridgeWrapper]
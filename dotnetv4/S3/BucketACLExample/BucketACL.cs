...
{
    // snippet-start:[S3.dotnetv4.BucketACLExample]
    using System;
    ...
    public static class BucketACL
    {
        ...
        // snippet-start:[S3.dotnetv4.PutBucketACLExample]
        ...
        // snippet-end:[S3.dotnetv4.PutBucketACLExample]

        // snippet-start:[S3.dotnetv4.GetBucketACLExample]
        ...
        public static async Task<GetBucketAclResponse> GetACLForBucketAsync(IAmazonS3 client, string newBucketName)
        {
            // Retrieve bucket ACL to show that the ACL was properly applied to
            // the new bucket.
            var getACLResponse = await client.GetBucketAclAsync(new GetBucketAclRequest
            {
                BucketName = newBucketName,
            });
        ...
        // snippet-end:[S3.dotnetv4.GetBucketACLExample]
        ...
        public static void DisplayACL(GetBucketAclResponse acl)
        {
            Console.WriteLine($"\nOwner: {acl.Owner}");
    ...
    // snippet-end:[S3.dotnetv4.BucketACLExample]
}
...
{
    // snippet-start:[S3.dotnetv4.ManageACLsExample]
    using System;
    ...
    public class ManageACLs
    {
        ...
        // snippet-start:[S3.dotnetv4.GetACL]
        ...
        /// GetACLAsync.</returns>
        public static async Task<List<S3Grant>> GetBucketACLAsync(IAmazonS3 client, string bucketName)
        {
        ...
        // snippet-end:[S3.dotnetv4.GetACL]

        // snippet-start:[S3.dotnetv4.PutACL]
        ...
        public static async Task AddACLToExistingObjectAsync(IAmazonS3 client, string bucketName, string keyName, string emailAddress)
        {
            ...
            var aclResponse = await client.GetObjectAclAsync(new GetObjectAclRequest
            {
                BucketName = bucketName,
                Key = keyName,
            });
        ...
        // snippet-end:[S3.dotnetv4.PutACL]
    }

    // snippet-end:[S3.dotnetv4.ManageACLsExample]
}
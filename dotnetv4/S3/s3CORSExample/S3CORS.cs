...
namespace S3CORSExample
{
    ...
    public class S3CORS
    {
        ...
        // snippet-start:[S3.dotnetv4.PutCORS]
        ...
        // snippet-end:[S3.dotnetv4.PutCORS]

        // snippet-start:[S3.dotnetv4.GetCORS]
        ...
        // snippet-end:[S3.dotnetv4.GetCORS]

        // snippet-start:[S3.dotnetv4.DeleteCORS]
        ...
        // snippet-end:[S3.dotnetv4.DeleteCORS]

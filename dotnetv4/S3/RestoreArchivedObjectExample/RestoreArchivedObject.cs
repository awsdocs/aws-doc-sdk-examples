...
{
    // snippet-start:[S3.dotnetv4.RestoreArchivedObjectExample]
    using System;
    ...
    public class RestoreArchivedObject
    {
        ...
        public static async Task CheckRestorationStatusAsync(IAmazonS3 client, string bucketName, string objectKey)
        {
            ...
            var restStatus = (bool)response.RestoreInProgress ? "in-progress" : "finished or failed";
            Console.WriteLine($"Restoration status: {restStatus}");
        }
    }

    // snippet-end:[S3.dotnetv4.RestoreArchivedObjectExample]
}
...
namespace TransferUtilityBasics
{
    ...
    {
        // snippet-start:[S3.dotnetv4.TransferUtilityBasics.DownloadSingleFileAsync]
        ...
        // snippet-end:[S3.dotnetv4.TransferUtilityBasics.DownloadSingleFileAsync]

        // snippet-start:[S3.dotnetv4.TransferUtilityBasics.DownloadS3DirectoryAsync]
        ...
        // snippet-end:[S3.dotnetv4.TransferUtilityBasics.DownloadS3DirectoryAsync]

        // snippet-start:[S3.dotnetv4.TransferUtilityBasics.UploadSingleFileAsync]
        ...
        // snippet-end:[S3.dotnetv4.TransferUtilityBasics.UploadSingleFileAsync]

        // snippet-start:[S3.dotnetv4.TransferUtilityBasics.UploadFullDirectoryAsync]
        ...
        // snippet-end:[S3.dotnetv4.TransferUtilityBasics.UploadFullDirectoryAsync]
    }
}
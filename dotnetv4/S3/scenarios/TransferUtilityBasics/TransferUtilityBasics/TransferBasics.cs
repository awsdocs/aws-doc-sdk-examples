...
// snippet-start:[S3.dotnetv4.TransferUtilityBasics.Main]
...
static string CenterText(string textToCenter)
{
    ...
    centeredText.Append(new string(' ', (screenWidth - textToCenter.Length) / 2));
...
// snippet-end:[S3.dotnetv4.TransferUtilityBasics.Main]
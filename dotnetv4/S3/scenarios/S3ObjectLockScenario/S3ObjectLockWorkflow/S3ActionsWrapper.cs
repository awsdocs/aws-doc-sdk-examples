...
// snippet-start:[S3LockWorkflow.dotnetv4.S3ActionsWrapper]
...
public class S3ActionsWrapper
{
    ...
    // snippet-start:[S3LockWorkflow.dotnetv4.CreateBucketWithObjectLock]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.CreateBucketWithObjectLock]

    // snippet-start:[S3LockWorkflow.dotnetv4.EnableObjectLockOnBucket]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.EnableObjectLockOnBucket]

    // snippet-start:[S3LockWorkflow.dotnetv4.ModifyObjectRetentionPeriod]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.ModifyObjectRetentionPeriod]

    // snippet-start:[S3LockWorkflow.dotnetv4.ModifyBucketDefaultRetention]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.ModifyBucketDefaultRetention]

    // snippet-start:[S3LockWorkflow.dotnetv4.GetObjectRetention]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.GetObjectRetention]

    // snippet-start:[S3LockWorkflow.dotnetv4.ModifyObjectLegalHold]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.ModifyObjectLegalHold]

    // snippet-start:[S3LockWorkflow.dotnetv4.GetObjectLegalHold]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.GetObjectLegalHold]

    // snippet-start:[S3LockWorkflow.dotnetv4.GetBucketObjectLockConfiguration]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.GetBucketObjectLockConfiguration]

    // snippet-start:[S3LockWorkflow.dotnetv4.UploadFileAsync]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.UploadFileAsync]

    // snippet-start:[S3LockWorkflow.dotnetv4.ListBucketObjectsAndVersions]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.ListBucketObjectsAndVersions]

    // snippet-start:[S3LockWorkflow.dotnetv4.DeleteObjectFromBucket]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.DeleteObjectFromBucket]

    // snippet-start:[S3LockWorkflow.dotnetv4.DeleteBucketByName]
    /// <summary>
    ...
    // snippet-end:[S3LockWorkflow.dotnetv4.DeleteBucketByName]

}
// snippet-end:[S3LockWorkflow.dotnetv4.S3ActionsWrapper]
...
// snippet-start:[S3.dotnetv4.ServerSideEncryption]
/// <summary>
...
public static class ServerSideEncryption
{
    ...
    // snippet-start:[S3.dotnetv4.PutBucketServerSideEncryption]
    /// <summary>
    ...
    // snippet-end:[S3.dotnetv4.PutBucketServerSideEncryption]

    // snippet-start:[S3.dotnetv4.GetBucketServerSideEncryption]
    /// <summary>
    ...
    // snippet-end:[S3.dotnetv4.GetBucketServerSideEncryption]
...
// snippet-end:[S3.dotnetv4.ServerSideEncryption]
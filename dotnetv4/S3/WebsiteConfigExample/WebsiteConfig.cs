...
{
    // snippet-start:[S3.dotnetv4.WebsiteConfigExample]
    using System;
    ...
    public class WebsiteConfig
    {
            ...
            string errorDocument)
        {
            try
            {
                // snippet-start:[S3.dotnetv4.PutWebsiteConfigExample]
                ...
                // snippet-end:[S3.dotnetv4.PutWebsiteConfigExample]

                // snippet-start:[S3.dotnetv4.GetWebsiteConfigExample]
                ...
                // snippet-end:[S3.dotnetv4.GetWebsiteConfigExample]
            }
    ...
    // snippet-end:[S3.dotnetv4.WebsiteConfigExample]
}
...
public class MediaConvertWrapper
{
    ...
    // snippet-start:[MediaConvert.dotnetv4.CreateJob]
    ...
    // snippet-end:[MediaConvert.dotnetv4.CreateJob]

    // snippet-start:[MediaConvert.dotnetv4.ListJobs]
    /// <summary>
    ...
    // snippet-end:[MediaConvert.dotnetv4.ListJobs]

    // snippet-start:[MediaConvert.dotnetv4.GetJob]
    /// <summary>
    ...
    // snippet-end:[MediaConvert.dotnetv4.GetJob]
}
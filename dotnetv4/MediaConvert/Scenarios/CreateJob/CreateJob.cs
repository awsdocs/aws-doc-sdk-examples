...
public class CreateJob
{
    static async Task Main(string[] args)
    {
        ...
        // snippet-start:[MediaConvert.dotnetv4.Setup]
        ...
        // snippet-end:[MediaConvert.dotnetv4.Setup]

        // snippet-start:[MediaConvert.dotnetv4.CreateJobSetup]
        ...
        Console.WriteLine(new string('-', 80));
        // snippet-end:[MediaConvert.dotnetv4.CreateJobSetup]

        // snippet-start:[MediaConvert.dotnetv4.GetJobSetup]
        Console.WriteLine(new string('-', 80));
        ...
        Console.WriteLine(new string('-', 80));
        // snippet-end:[MediaConvert.dotnetv4.GetJobSetup]

        // snippet-start:[MediaConvert.dotnetv4.ListJobsSetup]
        Console.WriteLine(new string('-', 80));
        ...
        // snippet-end:[MediaConvert.dotnetv4.ListJobsSetup]

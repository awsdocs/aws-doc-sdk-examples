...
// snippet-start:[Route53.dotnetv4.Route53Wrapper]
...
public class Route53Wrapper
{
    ...
    // snippet-start:[Route53.dotnetv4.ListPrices]
    ...
    // snippet-end:[Route53.dotnetv4.ListPrices]

    // snippet-start:[Route53.dotnetv4.CheckDomainAvailability]
    ...
    // snippet-end:[Route53.dotnetv4.CheckDomainAvailability]

    // snippet-start:[Route53.dotnetv4.CheckDomainTransferability]
    ...
    // snippet-end:[Route53.dotnetv4.CheckDomainTransferability]

    // snippet-start:[Route53.dotnetv4.GetDomainSuggestions]
    ...
    // snippet-end:[Route53.dotnetv4.GetDomainSuggestions]

    // snippet-start:[Route53.dotnetv4.GetOperationDetail]
    ...
    public async Task<string> GetOperationDetail(string? operationId)
    {
        ...
        try
        {
            ...
            var details = $"\tOperation {operationId}:\n" +
                          $"\tFor domain {operationDetails.DomainName} on {operationDetails.SubmittedDate.GetValueOrDefault().ToShortDateString()}.\n" +
    ...
    // snippet-end:[Route53.dotnetv4.GetOperationDetail]

    // snippet-start:[Route53.dotnetv4.RegisterDomain]
    ...
    // snippet-end:[Route53.dotnetv4.RegisterDomain]

    // snippet-start:[Route53.dotnetv4.ViewBilling]
    ...
    // snippet-end:[Route53.dotnetv4.ViewBilling]

    // snippet-start:[Route53.dotnetv4.ListDomains]
    ...
    // snippet-end:[Route53.dotnetv4.ListDomains]

    // snippet-start:[Route53.dotnetv4.ListOperations]
    ...
    // snippet-end:[Route53.dotnetv4.ListOperations]

    // snippet-start:[Route53.dotnetv4.GetDomainDetail]
    ...
    public async Task<string> GetDomainDetail(string domainName)
    {
        try
        {
            ...
            var details = $"\tDomain {domainName}:\n" +
                          $"\tCreated on {result.CreationDate.GetValueOrDefault().ToShortDateString()}.\n" +
    ...
    // snippet-end:[Route53.dotnetv4.GetDomainDetail]
}
// snippet-end:[Route53.dotnetv4.Route53Wrapper]
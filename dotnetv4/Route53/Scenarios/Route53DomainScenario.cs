...
// snippet-start:[Route53.dotnetv4.DomainBasics]
...
public static class Route53DomainScenario
{
   ...
   */
    ...
    private static async Task ListBillingRecords()
    {
        ...
        {
            Console.WriteLine($"\tBill Date: {billingRecords[i].BillDate.GetValueOrDefault().ToShortDateString()}");
...
// snippet-end:[Route53.dotnetv4.DomainBasics]
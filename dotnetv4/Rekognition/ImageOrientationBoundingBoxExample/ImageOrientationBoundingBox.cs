...
{
    // snippet-start:[Rekognition.dotnetv4.ImageOrientationBoundingBox]
    using System;
    ...
    public class ImageOrientationBoundingBox
    {
        ...
        public static void ShowBoundingBoxPositions(int imageHeight, int imageWidth, BoundingBox box, string rotation)
        {
            ...
            {
                case "ROTATE_0":
                    left = (float)(imageWidth * box.Left);
                    top = (float)(imageHeight * box.Top);
                    break;
                case "ROTATE_90":
                    left = (float)(imageHeight * (1 - (box.Top + box.Height)));
                    top = (float)(imageWidth * box.Left);
                    break;
                case "ROTATE_180":
                    left = (float)(imageWidth - (imageWidth * (box.Left + box.Width)));
                    top = (float)(imageHeight * (1 - (box.Top + box.Height)));
                    break;
                case "ROTATE_270":
                    left = (float)(imageHeight * box.Top);
                    top = (float)(imageWidth * (1 - box.Left - box.Width));
                    break;
                default:
    ...
    // snippet-end:[Rekognition.dotnetv4.ImageOrientationBoundingBox]
}
...
// snippet-start:[Aurora.dotnetv4.AuroraWrapper]
using Amazon.RDS;
...
public class AuroraWrapper
{
    ...
    // snippet-start:[Aurora.dotnetv4.DescribeEngineVersionsAsync]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.DescribeEngineVersionsAsync]

    // snippet-start:[Aurora.dotnetv4.CreateDBClusterParameterGroup]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.CreateDBClusterParameterGroup]

    // snippet-start:[Aurora.dotnetv4.DescribeDBClusterParameters]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.DescribeDBClusterParameters]

    // snippet-start:[Aurora.dotnetv4.DescribeDBClusterParameterGroups]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.DescribeDBClusterParameterGroups]

    // snippet-start:[Aurora.dotnetv4.ModifyDBClusterParameterGroup]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.ModifyDBClusterParameterGroup]


    // snippet-start:[Aurora.dotnetv4.DescribeOrderableDBInstanceOptions]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.DescribeOrderableDBInstanceOptions]

    // snippet-start:[Aurora.dotnetv4.DeleteDBClusterParameterGroup]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.DeleteDBClusterParameterGroup]

    // snippet-start:[Aurora.dotnetv4.CreateDBCluster]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.CreateDBCluster]

    // snippet-start:[Aurora.dotnetv4.DescribeDBInstances]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.DescribeDBInstances]

    // snippet-start:[Aurora.dotnetv4.DescribeDBClusters]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.DescribeDBClusters]

    // snippet-start:[Aurora.dotnetv4.CreateDBInstance]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.CreateDBInstance]

    // snippet-start:[Aurora.dotnetv4.CreateSnapshot]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.CreateSnapshot]

    // snippet-start:[Aurora.dotnetv4.DescribeDBSnapshots]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.DescribeDBSnapshots]

    // snippet-start:[Aurora.dotnetv4.DeleteDBCluster]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.DeleteDBCluster]

    // snippet-start:[Aurora.dotnetv4.DeleteDBInstance]
    /// <summary>
    ...
    // snippet-end:[Aurora.dotnetv4.DeleteDBInstance]
}
// snippet-end:[Aurora.dotnetv4.AuroraWrapper]
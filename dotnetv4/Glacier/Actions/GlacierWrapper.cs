...
// snippet-start:[Glacier.dotnetv4.GlacierActions]
...
public class GlacierWrapper
{
    ...
    // snippet-start:[Glacier.dotnetv4.GlacierActions.AddTagsToVault]
    /// <summary>
    ...
    // snippet-end:[Glacier.dotnetv4.GlacierActions.AddTagsToVault]

    // snippet-start:[Glacier.dotnetv4.GlacierActions.CreateVault]
    /// <summary>
    ...
    // snippet-end:[Glacier.dotnetv4.GlacierActions.CreateVault]

    // snippet-start:[Glacier.dotnetv4.GlacierActions.DescribeVault]
    /// <summary>
    ...
    // snippet-end:[Glacier.dotnetv4.GlacierActions.DescribeVault]

    // snippet-start:[Glacier.dotnetv4.GlacierActions.ArchiveTransferManager.Download]
    /// <summary>
    ...
    // snippet-end:[Glacier.dotnetv4.GlacierActions.ArchiveTransferManager.Download]

    // snippet-start:[Glacier.dotnetv4.GlacierActions.ListJobs]
    /// <summary>
    ...
    // snippet-end:[Glacier.dotnetv4.GlacierActions.ListJobs]

    // snippet-start:[Glacier.dotnetv4.GlacierActions.ListTagsForVault]
    /// <summary>
    ...
    // snippet-end:[Glacier.dotnetv4.GlacierActions.ListTagsForVault]

    // snippet-start:[Glacier.dotnetv4.GlacierActions.ListVaults]
    /// <summary>
    ...
    // snippet-end:[Glacier.dotnetv4.GlacierActions.ListVaults]

    // snippet-start:[Glacier.dotnetv4.GlacierActions.ArchiveTransferManager.Upload]
    /// <summary>
    ...
    // snippet-end:[Glacier.dotnetv4.GlacierActions.ArchiveTransferManager.Upload]

}

// snippet-end:[Glacier.dotnetv4.GlacierActions]
...
// snippet-start:[Keyspaces.dotnetv4.KeyspacesWrapper]
...
public class KeyspacesWrapper
{
    ...
    // snippet-start:[Keyspaces.dotnetv4.CreateKeyspace]
    /// <summary>
    ...
    // snippet-end:[Keyspaces.dotnetv4.CreateKeyspace]

    // snippet-start:[Keyspaces.dotnetv4.CreateTable]
    /// <summary>
    ...
    // snippet-end:[Keyspaces.dotnetv4.CreateTable]

    // snippet-start:[Keyspaces.dotnetv4.DeleteKeyspace]
    /// <summary>
    ...
    // snippet-end:[Keyspaces.dotnetv4.DeleteKeyspace]

    // snippet-start:[Keyspaces.dotnetv4.DeleteTable]
    /// <summary>
    ...
    // snippet-end:[Keyspaces.dotnetv4.DeleteTable]

    // snippet-start:[Keyspaces.dotnetv4.GetKeyspace]
    /// <summary>
    ...
    // snippet-end:[Keyspaces.dotnetv4.GetKeyspace]

    // snippet-start:[Keyspaces.dotnetv4.GetTable]
    /// <summary>
    ...
    // snippet-end:[Keyspaces.dotnetv4.GetTable]

    // snippet-start:[Keyspaces.dotnetv4.ListKeyspaces]
    /// <summary>
    ...
    // snippet-end:[Keyspaces.dotnetv4.ListKeyspaces]

    // snippet-start:[Keyspaces.dotnetv4.ListTables]
    /// <summary>
    ...
    // snippet-end:[Keyspaces.dotnetv4.ListTables]

    // snippet-start:[Keyspaces.dotnetv4.RestoreTable]
    /// <summary>
    ...
    // snippet-end:[Keyspaces.dotnetv4.RestoreTable]

    // snippet-start:[Keyspaces.dotnetv4.UpdateTable]
    /// <summary>
    ...
    // snippet-end:[Keyspaces.dotnetv4.UpdateTable]
}

// snippet-end:[Keyspaces.dotnetv4.KeyspacesWrapper]
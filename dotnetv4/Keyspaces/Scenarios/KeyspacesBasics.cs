...
// snippet-start:[Keyspaces.dotnetv4.KeyspacesScenario]
...
public class KeyspacesBasics
{
    ...
    static async Task Main(string[] args)
    {
        ...
        await keyspacesWrapper.CreateTable(keyspaceName, tableSchema, tableName);
...
// snippet-end:[Keyspaces.dotnetv4.KeyspacesScenario]
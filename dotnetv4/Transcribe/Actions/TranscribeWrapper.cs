...
public partial class TranscribeWrapper
{
    ...
    // snippet-start:[Transcribe.dotnetv4.StartTranscriptionJob]
    ...
    // snippet-end:[Transcribe.dotnetv4.StartTranscriptionJob]

    // snippet-start:[Transcribe.dotnetv4.GetTranscriptionJob]
    ...
    // snippet-end:[Transcribe.dotnetv4.GetTranscriptionJob]

    // snippet-start:[Transcribe.dotnetv4.ListTranscriptionJobs]
    ...
    // snippet-end:[Transcribe.dotnetv4.ListTranscriptionJobs]

    // snippet-start:[Transcribe.dotnetv4.DeleteTranscriptionJob]
    ...
    // snippet-end:[Transcribe.dotnetv4.DeleteTranscriptionJob]

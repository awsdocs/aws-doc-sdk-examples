...
{
    // snippet-start:[Transcribe.dotnetv4.CreateVocabularyAsync]
    ...
    // snippet-end:[Transcribe.dotnetv4.CreateVocabularyAsync]

    // snippet-start:[Transcribe.dotnetv4.GetVocabularyAsync]
    ...
    // snippet-end:[Transcribe.dotnetv4.GetVocabularyAsync]

    // snippet-start:[Transcribe.dotnetv4.DeleteVocabularyAsync]
    ...
    // snippet-end:[Transcribe.dotnetv4.DeleteVocabularyAsync]

    // snippet-start:[Transcribe.dotnetv4.ListCustomVocabularies]
    ...
    // snippet-end:[Transcribe.dotnetv4.ListCustomVocabularies]

    // snippet-start:[Transcribe.dotnetv4.UpdateCustomVocabulary]
    ...
    // snippet-end:[Transcribe.dotnetv4.UpdateCustomVocabulary]
}
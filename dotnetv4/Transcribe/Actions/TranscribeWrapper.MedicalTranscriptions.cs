...
{
    // snippet-start:[Transcribe.dotnetv4.StartMedicalTranscriptionJob]
    ...
    // snippet-end:[Transcribe.dotnetv4.StartMedicalTranscriptionJob]

    // snippet-start:[Transcribe.dotnetv4.GetMedicalTranscriptionJob]
    ...
    // snippet-end:[Transcribe.dotnetv4.GetMedicalTranscriptionJob]

    // snippet-start:[Transcribe.dotnetv4.ListMedicalTranscriptionJobs]
    ...
    // snippet-end:[Transcribe.dotnetv4.ListMedicalTranscriptionJobs]

    // snippet-start:[Transcribe.dotnetv4.DeleteMedicalTranscriptionJob]
    ...
    // snippet-end:[Transcribe.dotnetv4.DeleteMedicalTranscriptionJob]
}
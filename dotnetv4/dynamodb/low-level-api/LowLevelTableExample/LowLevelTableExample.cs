...
// snippet-start:[dynamodb.dotnetv4.LowLevelTableExample]
using System;
...
static class LowLevelTableExample
{
    ...
    // snippet-start:[dynamodb.dotnetv4.CreateExampleTable]
    ...
    // snippet-end:[dynamodb.dotnetv4.CreateExampleTable]

    // snippet-start:[dynamodb.dotnetv4.ListTableExample]
    ...
    // snippet-end:[dynamodb.dotnetv4.ListTableExample]

    // snippet-start:[dynamodb.dotnetv4.DescribeTableExample]
    ...
    // snippet-end:[dynamodb.dotnetv4.DescribeTableExample]

    // snippet-start:[dynamodb.dotnetv4.UpdateExampleTable]
    ...
    // snippet-end:[dynamodb.dotnetv4.UpdateExampleTable]

    // snippet-start:[dynamodb.dotnetv4.DeleteExampleTable]
    ...
    // snippet-end:[dynamodb.dotnetv4.DeleteExampleTable]

    // snippet-start:[dynamodb.dotnetv4.WaitUntilTableReady]
    ...
    // snippet-end:[dynamodb.dotnetv4.WaitUntilTableReady]
}
// snippet-end:[dynamodb.dotnetv4.LowLevelTableExample]
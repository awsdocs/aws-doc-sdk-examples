...
// snippet-start:[PartiQL.dotnetv4.PartiQLBasicsScenario-Complete]
namespace PartiQL_Basics_Scenario
{
    public class PartiQLMethods
    {
        ...
        // snippet-start:[PartiQL.dotnetv4.PartiQLBasicsScenario-InsertMovies]
        ...
        // snippet-end:[PartiQL.dotnetv4.PartiQLBasicsScenario-InsertMovies]

        // snippet-start:[PartiQL.dotnetv4.PartiQLBasicsScenario-GetSingleMovie]
        ...
        // snippet-end:[PartiQL.dotnetv4.PartiQLBasicsScenario-GetSingleMovie]

        // snippet-start:[PartiQL.dotnetv4.PartiQLBasicsScenario-GetMovies]
        ...
        // snippet-end:[PartiQL.dotnetv4.PartiQLBasicsScenario-GetMovies]

        // snippet-start:[PartiQL.dotnetv4.PartiQLBasicsScenario-InsertSingleMovie]
        ...
        // snippet-end:[PartiQL.dotnetv4.PartiQLBasicsScenario-InsertSingleMovie]

        // snippet-start:[PartiQL.dotnetv4.PartiQLBasicsScenario-UpdateSingleMovie]
        ...
        // snippet-end:[PartiQL.dotnetv4.PartiQLBasicsScenario-UpdateSingleMovie]

        // snippet-start:[PartiQL.dotnetv4.PartiQLBasicsScenario-DeleteSingleMovie]
        ...
        // snippet-end:[PartiQL.dotnetv4.PartiQLBasicsScenario-DeleteSingleMovie]
...
// snippet-end:[PartiQL.dotnetv4.PartiQLBasicsScenario-Complete]
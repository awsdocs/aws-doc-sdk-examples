...
namespace PartiQL_Batch_Scenario
{
    public class PartiQLBatchMethods
    {
        ...
        // snippet-start:[PartiQL.dotnetv4.PartiQLBatchScenario-InsertMovies]
        /// <summary>
        ...
        // snippet-end:[PartiQL.dotnetv4.PartiQLBatchScenario-InsertMovies]

        // snippet-start:[PartiQL.dotnetv4.PartiQLBatchScenario-GetBatch]
        /// <summary>
        ...
        // snippet-end:[PartiQL.dotnetv4.PartiQLBatchScenario-GetBatch]

        // snippet-start:[PartiQL.dotnetv4.PartiQLBatchScenario-UpdateBatch]
        /// <summary>
        ...
        // snippet-end:[PartiQL.dotnetv4.PartiQLBatchScenario-UpdateBatch]

        // snippet-start:[PartiQL.dotnetv4.PartiQLBatchScenario-DeleteBatch]
        /// <summary>
        ...
        // snippet-end:[PartiQL.dotnetv4.PartiQLBatchScenario-DeleteBatch]
    }
}
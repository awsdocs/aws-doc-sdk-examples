...
// snippet-start:[IAM.dotnetv4.IAMWrapper]
...
public class IAMWrapper
{
    ...
    // snippet-start:[IAM.dotnetv4.AttachRolePolicy]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.AttachRolePolicy]

    // snippet-start:[IAM.dotnetv4.CreateAccessKey]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.CreateAccessKey]

    // snippet-start:[IAM.dotnetv4.CreatePolicy]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.CreatePolicy]

    // snippet-start:[IAM.dotnetv4.CreateRole]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.CreateRole]

    // snippet-start:[IAM.dotnetv4.CreateServiceLinkedRole]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.CreateServiceLinkedRole]

    // snippet-start:[IAM.dotnetv4.CreateUser]
    /// <summary>
    /// Create an IAM user.
    /// </summary>
    ...
    // snippet-end:[IAM.dotnetv4.CreateUser]

    // snippet-start:[IAM.dotnetv4.DeleteAccessKey]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.DeleteAccessKey]

    // snippet-start:[IAM.dotnetv4.DeletePolicy]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.DeletePolicy]

    // snippet-start:[IAM.dotnetv4.DeleteRole]
    /// <summary>
    /// Delete an IAM role.
    /// </summary>
    ...
    // snippet-end:[IAM.dotnetv4.DeleteRole]

    // snippet-start:[IAM.dotnetv4.DeleteRolePolicy]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.DeleteRolePolicy]

    // snippet-start:[IAM.dotnetv4.DeleteUser]
    /// <summary>
    /// Delete an IAM user.
    /// </summary>
    ...
    // snippet-end:[IAM.dotnetv4.DeleteUser]

    // snippet-start:[IAM.dotnetv4.DeleteUserPolicy]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.DeleteUserPolicy]

    // snippet-start:[IAM.dotnetv4.DetachRolePolicy]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.DetachRolePolicy]

    // snippet-start:[IAM.dotnetv4.GetAccountPasswordPolicy]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.GetAccountPasswordPolicy]

    // snippet-start:[IAM.dotnetv4.GetPolicy]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.GetPolicy]

    // snippet-start:[IAM.dotnetv4.GetRole]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.GetRole]

    // snippet-start:[IAM.dotnetv4.GetUser]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.GetUser]

    // snippet-start:[IAM.dotnetv4.ListAttachedRolePolicies]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.ListAttachedRolePolicies]

    // snippet-start:[IAM.dotnetv4.ListGroups]
    /// <summary>
    /// List IAM groups.
    /// </summary>
    ...
    // snippet-end:[IAM.dotnetv4.ListGroups]

    // snippet-start:[IAM.dotnetv4.ListPolicies]
    /// <summary>
    /// List IAM policies.
    /// </summary>
    ...
    // snippet-end:[IAM.dotnetv4.ListPolicies]

    // snippet-start:[IAM.dotnetv4.ListRolePolicies]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.ListRolePolicies]

    // snippet-start:[IAM.dotnetv4.ListRoles]
    /// <summary>
    /// List IAM roles.
    /// </summary>
    ...
    // snippet-end:[IAM.dotnetv4.ListRoles]

    // snippet-start:[IAM.dotnetv4.ListSAMLProviders]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.ListSAMLProviders]

    // snippet-start:[IAM.dotnetv4.ListUsers]
    /// <summary>
    /// List IAM users.
    /// </summary>
    ...
    // snippet-end:[IAM.dotnetv4.ListUsers]

    // snippet-start:[IAM.dotnetv4.PutRolePolicy]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.PutRolePolicy]

    // snippet-start:[IAM.dotnetv4.PutUserPolicy]
    /// <summary>
    ...
    // snippet-end:[IAM.dotnetv4.PutUserPolicy]
    /// <summary>
...
// snippet-end:[IAM.dotnetv4.IAMWrapper]
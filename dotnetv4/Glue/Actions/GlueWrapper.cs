...
// snippet-start:[Glue.dotnetv4.GlueWrapper]
...
public class GlueWrapper
{
    ...
    // snippet-start:[Glue.dotnetv4.CreateCrawler]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.CreateCrawler]

    // snippet-start:[Glue.dotnetv4.CreateJob]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.CreateJob]

    // snippet-start:[Glue.dotnetv4.DeleteCrawler]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.DeleteCrawler]

    // snippet-start:[Glue.dotnetv4.DeleteDatabase]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.DeleteDatabase]

    // snippet-start:[Glue.dotnetv4.DeleteJob]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.DeleteJob]

    // snippet-start:[Glue.dotnetv4.DeleteTable]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.DeleteTable]

    // snippet-start:[Glue.dotnetv4.GetCrawler]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.GetCrawler]

    // snippet-start:[Glue.dotnetv4.GetCrawlerState]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.GetCrawlerState]

    // snippet-start:[Glue.dotnetv4.GetDatabase]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.GetDatabase]

    // snippet-start:[Glue.dotnetv4.GetJobRun]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.GetJobRun]

    // snippet-start:[Glue.dotnetv4.GetJobRuns]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.GetJobRuns]

    // snippet-start:[Glue.dotnetv4.GetTables]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.GetTables]

    // snippet-start:[Glue.dotnetv4.ListJobs]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.ListJobs]

    // snippet-start:[Glue.dotnetv4.StartCrawler]
    /// <summary>
    ...
    //snippet-end:[Glue.dotnetv4.StartCrawler]

    // snippet-start:[Glue.dotnetv4.StartJobRun]
    /// <summary>
    ...
    // snippet-end:[Glue.dotnetv4.StartJobRun]
}

// snippet-end:[Glue.dotnetv4.GlueWrapper]
...
// snippet-start:[StepFunctions.dotnetv4.StepFunctionsActions]
...
public class StepFunctionsWrapper
{
    ...
    // snippet-start:[StepFunctions.dotnetv4.CreateActivity]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.CreateActivity]

    // snippet-start:[StepFunctions.dotnetv4.CreateStateMachine]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.CreateStateMachine]

    // snippet-start:[StepFunctions.dotnetv4.DeleteActivity]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.DeleteActivity]

    // snippet-start:[StepFunctions.dotnetv4.DeleteStateMachine]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.DeleteStateMachine]

    // snippet-start:[StepFunctions.dotnetv4.DescribeExecution]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.DescribeExecution]

    // snippet-start:[StepFunctions.dotnetv4.DescribeStateMachine]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.DescribeStateMachine]

    // snippet-start:[StepFunctions.dotnetv4.GetActivityTask]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.GetActivityTask]

    // snippet-start:[StepFunctions.dotnetv4.ListActivities]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.ListActivities]

    // snippet-start:[StepFunctions.dotnetv4.ListExecutions]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.ListExecutions]

    // snippet-start:[StepFunctions.dotnetv4.ListStateMachines]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.ListStateMachines]

    // snippet-start:[StepFunctions.dotnetv4.SendTaskSuccess]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.SendTaskSuccess]

    // snippet-start:[StepFunctions.dotnetv4.StartExecution]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.StartExecution]

    // snippet-start:[StepFunctions.dotnetv4.StopExecution]
    /// <summary>
    ...
    // snippet-end:[StepFunctions.dotnetv4.StopExecution]

}

// snippet-end:[StepFunctions.dotnetv4.StepFunctionsActions]
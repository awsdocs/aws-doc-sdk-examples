...
# snippet-end:[aws-cli.bash-linux.ec2.errecho]

# snippet-start:[aws-cli.bash-linux.ec2.iecho]
###############################################################################
# function iecho
#
...
# snippet-end:[aws-cli.bash-linux.ec2.iecho]
...
# snippet-start:[aws-cli.bash-linux.ec2.aws_cli_error_log]
##############################################################################
...
# snippet-end:[aws-cli.bash-linux.ec2.aws_cli_error_log]

# API Gateway code examples for the SDK for SAP ABAP

## Overview

Shows how to use the AWS SDK for SAP ABAP to work with Amazon API Gateway.
...
- [SDK for SAP ABAP API Gateway reference](https://docs.aws.amazon.com/sdk-for-sap-abap/v1/api/latest/api-gateway/index.html)

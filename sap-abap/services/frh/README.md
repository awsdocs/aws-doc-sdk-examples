# Data Firehose code examples for the SDK for SAP ABAP

## Overview

Shows how to use the AWS SDK for SAP ABAP to work with Amazon Data Firehose.
...
- [SDK for SAP ABAP Data Firehose reference](https://docs.aws.amazon.com/sdk-for-sap-abap/v1/api/latest/firehose/index.html)

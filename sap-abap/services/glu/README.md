# AWS Glue code examples for the SDK for SAP ABAP

## Overview

Shows how to use the AWS SDK for SAP ABAP to work with AWS Glue.
...
- [SDK for SAP ABAP AWS Glue reference](https://docs.aws.amazon.com/sdk-for-sap-abap/v1/api/latest/glue/index.html)

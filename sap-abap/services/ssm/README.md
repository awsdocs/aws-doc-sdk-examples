# Systems Manager code examples for the SDK for SAP ABAP

## Overview

Shows how to use the AWS SDK for SAP ABAP to work with AWS Systems Manager.
...
- [SDK for SAP ABAP Systems Manager reference](https://docs.aws.amazon.com/sdk-for-sap-abap/v1/api/latest/ssm/index.html)

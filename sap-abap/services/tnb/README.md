# Amazon Transcribe code examples for the SDK for SAP ABAP

## Overview

Shows how to use the AWS SDK for SAP ABAP to work with Amazon Transcribe.
...
- [SDK for SAP ABAP Amazon Transcribe reference](https://docs.aws.amazon.com/sdk-for-sap-abap/v1/api/latest/transcribe/index.html)

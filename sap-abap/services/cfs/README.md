# AWS Config code examples for the SDK for SAP ABAP

## Overview

Shows how to use the AWS SDK for SAP ABAP to work with AWS Config.
...
- [SDK for SAP ABAP AWS Config reference](https://docs.aws.amazon.com/sdk-for-sap-abap/v1/api/latest/config-service/index.html)

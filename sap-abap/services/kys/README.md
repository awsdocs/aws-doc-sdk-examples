# Amazon Keyspaces code examples for the SDK for SAP ABAP

## Overview

Shows how to use the AWS SDK for SAP ABAP to work with Amazon Keyspaces (for Apache Cassandra).
...
- [SDK for SAP ABAP Amazon Keyspaces reference](https://docs.aws.amazon.com/sdk-for-sap-abap/v1/api/latest/keyspaces/index.html)

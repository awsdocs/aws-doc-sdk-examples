# Amazon Pinpoint code examples for the SDK for SAP ABAP

## Overview

Shows how to use the AWS SDK for SAP ABAP to work with Amazon Pinpoint.
...
- [SDK for SAP ABAP Amazon Pinpoint reference](https://docs.aws.amazon.com/sdk-for-sap-abap/v1/api/latest/pinpoint/index.html)

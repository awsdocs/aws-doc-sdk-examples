...
- [Image generation with Stability.ai Stable Diffusion XL](zcl_aws1_bdr_actions.clas.abap#L179) (`InvokeModel`)
- [Text generation with Anthropic Claude 2](zcl_aws1_bdr_actions.clas.abap#L109) (`InvokeModel`)

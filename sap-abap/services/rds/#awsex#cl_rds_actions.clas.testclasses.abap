...
CLASS ltc_awsex_cl_rds_actions DEFINITION FOR TESTING DURATION LONG RISK LEVEL DANGEROUS.
  ...
  PRIVATE SECTION.
    ...
    " Test methods matching each action method
...
CLASS ltc_awsex_cl_rds_actions IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    gv_param_group_name_2 = |abap-rds-pg2-{ lv_uuid_string+0(7) }|.
    gv_cluster_id_2 = |abap-rds-cl2-{ lv_uuid_string+0(7) }|.
    gv_instance_id_2 = |abap-rds-in2-{ lv_uuid_string+0(7) }|.
  ...
  METHOD class_teardown.
    ...
    " Note: RDS resources take long to delete, so we tag them for manual cleanup
    TRY.
  ...
  METHOD delete_parameter_group.
    TRY.
        ...
        " Verify deletion
        TRY.
            ao_rds_actions->get_parameter_group(
              iv_param_group_name = gv_param_group_name_2
            ).
  ...
  METHOD get_orderable_instances.
    DATA lt_options TYPE /aws1/cl_rdsorderabledbinsto01=>tt_orderabledbinstooptlist.

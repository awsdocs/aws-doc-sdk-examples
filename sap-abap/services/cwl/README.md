# CloudWatch Logs code examples for the SDK for SAP ABAP

## Overview

Shows how to use the AWS SDK for SAP ABAP to work with Amazon CloudWatch Logs.
...
- [SDK for SAP ABAP CloudWatch Logs reference](https://docs.aws.amazon.com/sdk-for-sap-abap/v1/api/latest/cloudwatch-logs/index.html)

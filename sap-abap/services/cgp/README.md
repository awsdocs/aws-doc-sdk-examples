# Amazon Cognito Identity Provider code examples for the SDK for SAP ABAP

## Overview

Shows how to use the AWS SDK for SAP ABAP to work with Amazon Cognito Identity Provider.
...
- [SDK for SAP ABAP Amazon Cognito Identity Provider reference](https://docs.aws.amazon.com/sdk-for-sap-abap/v1/api/latest/cognito-identity-provider/index.html)

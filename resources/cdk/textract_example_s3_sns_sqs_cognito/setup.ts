...
export class SetupStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const exampleUserPoolClient = exampleUserPool.addClient(
      "textract-cognito-demo-client-id",
      {
    ...
    const exampleIdentityPool = new CfnIdentityPool(
      this,
      "textract-cognito-demo-idpool",
      {
    ...
    const authenticatedRole = new Role(
      this,
      "textract-cognito-demo-authenticated-role",
      {
        assumedBy: new FederatedPrincipal(
          "cognito-identity.amazonaws.com",
          {
            StringEquals: {
              "cognito-identity.amazonaws.com:aud": exampleIdentityPool.ref,
            },
    ...
    new CfnOutput(this, "CognitoId", {
      value: `cognito-idp.${this.region}.amazonaws.com/${exampleUserPool.userPoolId}`,
    });
    new CfnOutput(this, "CognitoUserPoolId", {
      value: exampleUserPool.userPoolId,
    });
    new CfnOutput(this, "CognitoIdentityPoolId", {
      value: exampleIdentityPool.ref,
    });

  ...
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const workflow_support_role = new iam.Role(this, "WorkflowRole", {
      assumedBy: new iam.FederatedPrincipal(
        ...
        {
          StringEquals: {
            "cognito-identity.amazonaws.com:aud": myIdentityPool_workflow.ref,
          },
          "ForAnyValue:StringLike": {
            "cognito-identity.amazonaws.com:amr": "unauthenticated",
          },
    ...
    new CfnOutput(this, "Lambda support role", {
      value: lambda_support_role.roleName,
    });
    new CfnOutput(this, "Workflow support role", {
      value: workflow_support_role.roleName,
    });
  }
}

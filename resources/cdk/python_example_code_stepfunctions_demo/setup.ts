...
export class SetupStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const lambda_role: Role = new Role(
      this,
      "doc-example-stepfunctions-lambda-messages-role",
      {
    ...
    const step_role: Role = new Role(
      this,
      "doc-example-stepfunctions-messages-role",
      {

...
// snippet-start:[dynamodb.dotnet3.CreateTablesLoadData]
using System;
...
namespace com.amazonaws.codesamples
{
    class CreateTablesLoadData
    {
        ...
        private static void DeleteTable(AmazonDynamoDBClient client, string tableName)
        {
            try
            {
        ...
        private static void LoadSampleProducts(AmazonDynamoDBClient client)
        {
        ...
        private static void LoadSampleForums(AmazonDynamoDBClient client)
        {
        ...
        private static void LoadSampleThreads(AmazonDynamoDBClient client)
        {
        ...
        private static void LoadSampleReplies(AmazonDynamoDBClient client)
        {

...
// snippet-sourcedescription:[SSEClientEncryptionKeyObjectOperationsTest.cs demonstrates how server-side encryption with customer-provided keys (SSE-C) works.]
// snippet-service:[s3]

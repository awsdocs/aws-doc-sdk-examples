...
// snippet-start:[presigned.java2.generatepresignedurlpublicacl.complete]
package com.example.s3;

// snippet-start:[presigned.java2.generatepresignedurlpublicacl.import]
...
// snippet-end:[presigned.java2.generatepresignedurlpublicacl.import]

public class GeneratePresignedUrlAndUploadPublicObject {
    ...
    public static void main(String[] args) {
        ...
        // snippet-start:[presigned.java2.generatepresignedurlpublicacl.main]
        ...
        try {
            PresignedPutObjectRequest presignedRequest =
                    presigner.presignPutObject(z -> z.signatureDuration(Duration.ofMinutes(10))
                            .putObjectRequest(por -> por.bucket(bucketName).key(keyName).acl(ObjectCannedACL.PUBLIC_READ)));
        ...
        // snippet-end:[presigned.java2.generatepresignedurlpublicacl.main]
    }
}
// snippet-end:[presigned.java2.generatepresignedurlpublicacl.complete]
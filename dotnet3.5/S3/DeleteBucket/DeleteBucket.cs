...
namespace DeleteBucket
{
    class DeleteBucket
    {
        // Change the name of the following constant to the region containing the bucket
        ...
        private const string BUCKET_NAME = "*** provide the name of the bucket with source object ***";

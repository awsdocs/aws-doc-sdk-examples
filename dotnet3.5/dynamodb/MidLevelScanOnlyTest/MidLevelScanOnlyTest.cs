...
namespace DynamoDBCRUD
{
    public class MidLevelScanOnlyTest
    {
        ...
        public async void CheckMidLevelScanOnly()
        {
            ...
            // Scan example.
            MidLevelScanOnly.FindProductsWithNegativePrice(client, productCatalogTable);
            MidLevelScanOnly.FindProductsWithNegativePriceWithConfig(client, productCatalogTable);

...
namespace MidLevelBatchWriteItemTest
{
    public class MidLevelBatchWriteItemTest
    {
        ...
        public async void CheckMidLevelBatchWriteItem()
        {
            ...
            // Test 
            _output.WriteLine("Testing MidLevelBatchWriteItem methods");
            MidLevelBatchWriteItem.MidLevelBatchWriteItem.SingleTableBatchWrite(client);
            MidLevelBatchWriteItem.MidLevelBatchWriteItem.MultiTableBatchWrite(client);

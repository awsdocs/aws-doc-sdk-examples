...
public class MigrationHubServiceIntegrationTest {
    ...
    public static void setUp() throws IOException {
        ...
        try (InputStream input = MigrationHubServiceIntegrationTest.class.getClassLoader().getResourceAsStream("config.properties")) {
            ...
            //existingmigrationtask = prop.getProperty("existingmigrationtask");
            migrationtask = prop.getProperty("migrationtask");
            progress = prop.getProperty("progress");
            //newprogress = prop.getProperty("newprogress");

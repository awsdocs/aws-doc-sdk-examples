...
public class MediaStoreTest {
   ...
   public void PutObject() throws URISyntaxException {
       ...
       assertDoesNotThrow(() -> PutObject.putMediaObject(mediaStoreDataOb, s3, bucketName, filePath, completePath));
    ...
    public void GetObject() throws URISyntaxException {
        ...
        assertDoesNotThrow(() ->GetObject.getMediaObject(mediaStoreDataOb, completePath));
        System.out.println("Test 4 passed");
    }

...
public class MediaStoreServiceIntegrationTest {
    ...
    public static void setUp() throws IOException, URISyntaxException {
        ...
        try (InputStream input = MediaStoreServiceIntegrationTest.class.getClassLoader().getResourceAsStream("config.properties")) {

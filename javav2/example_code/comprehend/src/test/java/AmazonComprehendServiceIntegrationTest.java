...
public class AmazonComprehendServiceIntegrationTest {
    ...
    public static void setUp() throws IOException {
        ...
        try (InputStream input = AmazonComprehendServiceIntegrationTest.class.getClassLoader().getResourceAsStream("config.properties")) {

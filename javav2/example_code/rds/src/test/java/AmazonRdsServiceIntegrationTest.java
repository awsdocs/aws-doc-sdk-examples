...
public class AmazonRdsServiceIntegrationTest {
    ...
    public static void setUp() throws IOException {
        ...
        try (InputStream input = AmazonRdsServiceIntegrationTest.class.getClassLoader().getResourceAsStream("config.properties")) {

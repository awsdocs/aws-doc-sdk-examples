...
public class NewsletterWorkflow {
  ...
  public void prepareApplication() throws IOException {
    ...
    // snippet-end:[sesv2.java2.newsletter.CreateEmailIdentity]
    ...
    // snippet-end:[sesv2.java2.newsletter.CreateContactList]
  ...
  public void gatherSubscriberEmails() throws IOException {
    ...
    for (String emailAddress : createSubscriberSubaddresses(baseEmail)) {
      ...
      // snippet-start:[sesv2.java2.newsletter.CreateContact]
      try {
        ...
        // snippet-start:[sesv2.java2.newsletter.SendEmail.simple]
        ...
        // snippet-end:[sesv2.java2.newsletter.SendEmail.simple]
      } catch (AlreadyExistsException e) {
    ...
    // snippet-end:[sesv2.java2.newsletter.CreateContact]
  }
   ...
   */
  public void cleanUp() {
    // snippet-start:[sesv2.java2.newsletter.DeleteContactList]
    try {
    ...
    // snippet-end:[sesv2.java2.newsletter.DeleteContactList]

    // snippet-start:[sesv2.java2.newsletter.DeleteEmailTemplate]
    try {
      // Delete the template

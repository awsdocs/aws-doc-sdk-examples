...
public class AsyncPagination {
    ...
    private static void AutoPagination() throws InterruptedException, ExecutionException {
        ...
        // snippet-start:[dynamodb.java.async_pagination.pagesclient]
        // Creates a default client with credentials and regions loaded from the environment
        final DynamoDbAsyncClient asyncClient = DynamoDbAsyncClient.create();

        ListTablesRequest listTablesRequest = ListTablesRequest.builder().limit(3).build();
        // snippet-end:[dynamodb.java.async_pagination.pagesclient]
        // snippet-start:[dynamodb.java.async_pagination.pagesforeach]
        ...
        // snippet-end:[dynamodb.java.async_pagination.pagesforeach]

        future.get();

        // snippet-start:[dynamodb.java.async_pagination.pagessubscribe]
        ...
        publisher.subscribe(new Subscriber<ListTablesResponse>() {
            ...
            // snippet-end:[dynamodb.java.async_pagination.pagessubscribe]
        });
    ...
    private static void AutoPaginationOnCollection() throws InterruptedException, ExecutionException {
        // snippet-start:[dynamodb.java.async_pagination.asyncclient]
        ...
        ListTablesRequest listTablesRequest = ListTablesRequest.builder().limit(3).build();        
        // snippet-end:[dynamodb.java.async_pagination.asyncclient]
        ...
        // snippet-start:[dynamodb.java.async_pagination.foreach]
        // Use forEach
        CompletableFuture<Void> future = publisher.subscribe(System.out::println);
        future.get();
        // snippet-end:[dynamodb.java.async_pagination.foreach]

        
        // snippet-start:[dynamodb.java.async_pagination.subscriber]
        // Use subscriber
        publisher.subscribe(new Subscriber<String>() {
            ...
            @Override
            public void onComplete() { }
            // snippet-end:[dynamodb.java.async_pagination.subscriber]
        });
    ...
    private static void useThirdPartySubscriber() {
        // snippet-start:[dynamodb.java.async_pagination.async]
        ...
        // snippet-end:[dynamodb.java.async_pagination.async]
    }

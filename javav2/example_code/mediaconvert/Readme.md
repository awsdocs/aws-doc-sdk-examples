...
For systems with Bash support, once you set the **CLASSPATH**, you can run a particular example as follows.
	...
	java com.example.mediaconvert.ListJobs

 ## Testing the AWS Elemental MediaConvert files

You can test the Java code examples for AWS Elemental MediaConvert by running a test file named **AmazonMediaConvertServiceIntegrationTest**. This file uses JUnit 5 to run the JUnit tests and is located in the **src/test/java** folder. For more information, see [https://junit.org/junit5/](https://junit.org/junit5/).
...
You will see output from the JUnit tests, as shown here.
	...
	[INFO]  T E S T S
	[INFO] -------------------------------------------------------
	[INFO] Running AmazonMediaConvertServiceIntegrationTest
	Test 1 passed
	Test 2 passed
	...
	Done!

...
For systems with Bash support, once you set the **CLASSPATH**, you can run a particular example as follows.
	...
	java com.example.cloudformation.DescribeStacks
...
- **roleARN** – The Amazon Resource Number (ARN) of the role that has CloudFormation permissions (as well as Amazon S3 and Amazon EC2 permissions).

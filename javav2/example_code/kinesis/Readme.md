...
For systems with Bash support, once you set the **CLASSPATH**, you can run a particular example as follows.
	...
	java com.example.kinesis.DescribeLimits


 ## Testing the Amazon Kinesis files

You can test the Java code examples for Amazon Kinesis by running a test file named **KinesisServiceIntegrationTest**. This file uses JUnit 5 to run the JUnit tests and is located in the **src/test/java** folder. For more information, see [https://junit.org/junit5/](https://junit.org/junit5/).

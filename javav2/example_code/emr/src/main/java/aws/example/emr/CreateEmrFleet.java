 ...
 *
 * Also. to run the CreateEmrFleet example, it is recommended that you go
    ...
    public static void createFleet(EmrClient emr) {
        try {
            ...
            InstanceFleetConfig masterFleet = InstanceFleetConfig.builder()
                ...
                .instanceTypeConfigs(Arrays.asList(m3xLarge, m4xLarge, m5xLarge))
            ...
            InstanceFleetConfig coreFleet = InstanceFleetConfig.builder()
                ...
                .instanceTypeConfigs(Arrays.asList(m3xLarge, m4xLarge, r4xlarge, r3xlarge, c32xlarge))
            ...
            InstanceFleetConfig taskFleet = InstanceFleetConfig.builder()
                ...
                .instanceTypeConfigs(Arrays.asList(m4xLarge, r5xlarge, r4xlarge, c32xlarge, c42xlarge))
            ...
            JobFlowInstancesConfig flowInstancesConfig = JobFlowInstancesConfig.builder()
                ...
                .instanceFleets(Arrays.asList(masterFleet, coreFleet, taskFleet))
            ...
            RunJobFlowRequest flowRequest = RunJobFlowRequest.builder()
                ...
                .applications(java.util.Arrays.asList(Application.builder().name("Spark").build()))

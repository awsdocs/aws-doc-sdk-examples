...
/**
 * To run this example, you need a JSON file that represents the Amazon States
 * Language definition for the state machine.
 *
 * To see an Amazon States Language definition example that you can use, see
 * "Getting started with AWS Step Functions" at

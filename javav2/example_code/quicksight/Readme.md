...
**Note**: Before testing these Java code examples, create these respurces by following [Getting Started with Data Analysis in Amazon QuickSight](https://docs.aws.amazon.com/quicksight/latest/user/getting-started.html).  .

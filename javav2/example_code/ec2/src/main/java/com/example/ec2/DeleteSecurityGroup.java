...
// snippet-start:[ec2.java.delete_security_group.complete]
// snippet-start:[ec2.java.delete_security_group.import]
import software.amazon.awssdk.services.ec2.Ec2Client;
import software.amazon.awssdk.services.ec2.model.DeleteSecurityGroupRequest;
import software.amazon.awssdk.services.ec2.model.DeleteSecurityGroupResponse;
 
// snippet-end:[ec2.java.delete_security_group.import]
/**
...
public class DeleteSecurityGroup
{
    public static void main(String[] args)
    {
        ...
        // snippet-start:[ec2.java.delete_security_group.main]
        ...
        // snippet-end:[ec2.java.delete_security_group.main]
        System.out.printf(
            "Successfully deleted security group with id %s", group_id);
    }
}
 
// snippet-end:[ec2.java.delete_security_group.complete]

 ...
 *
 * 1. Create an RSA key pair and save the private key material as a.pem file.
 * 2. List key pairs.
 * 3. Create a security group for the default VPC, add an inbound rule to allow SSH from the current computer’s public IPv4 address.
 * 4. Display security group information.
 * 5. Gets a list of Amazon Linux 2 AMIs and selects one. SSM is best practice, using path and then filter the list after the fact to include ‘amzn2’
 * 6. Gets more information about the image.
 * 7. Gets a list of instance types that are compatible with the selected AMI’s architecture.
 * 8. Create an instance with the key pair, security group, AMI, and instance type
 * 9. Display information about the instance.
 * 10. Stop the instance, wait for it to stop.
 * 11. Start the instance, wait for it to start.
 * 12. Allocate an Elastic IP and associate it with the instance.
 * 13. Display SSH connection info for the instance. Note that the public IP is the Elastic IP, which stays constant.
 * 14. Disassociate and delete Elastic IP.
...
public class EC2Scenario {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String keyName = "scottKey11" ; //args[0];
        String fileName = "C:\\AWS\\ec2Key.pem" ; //args[0];
        String groupName = "TestSecGroup11"; //args[0];
        ...
        String associationId = allocateAddress(ec2, newInstanceId);
        ...
        System.out.println(DASHES);
        System.out.println("14. Disassociate and delete Elastic IP");
    ...
    public static String allocateAddress(Ec2Client ec2, String instanceId) {
        try {

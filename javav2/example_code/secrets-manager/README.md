# Secrets Manager code examples for the SDK for Java 2.x
...
To find instructions for running the code example, see the [README](../../README.md#build-and-run-the-service-examples)

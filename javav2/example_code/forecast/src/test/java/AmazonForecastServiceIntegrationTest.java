...
public class AmazonForecastServiceIntegrationTest {
    ...
    public static void setUp() throws IOException {
        ...
        try (InputStream input = AmazonForecastServiceIntegrationTest.class.getClassLoader().getResourceAsStream("config.properties")) {

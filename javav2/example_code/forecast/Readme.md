# Amazon Forecast Java Readme

A README that discusses how to run and test the Java Amazon Forecast code examples.
...
Once you set the **CLASSPATH**, you can run a particular example like this:
	...
	java com.example.forecast.ListDataSets

For systems with bash support.

 ## Testing the Amazon Forecast files

You can test the Amazon Forecast Java code examples by running a test file named **AmazonForecastServiceIntegrationTest**. This file uses JUnit 5 to run the JUnit tests and is located in the **src/test/java** folder. For more information, see [https://junit.org/junit5/](https://junit.org/junit5/) .
...
You will see output from the JUnit tests, as shown here:
	...
	[INFO]  T E S T S
	[INFO] -------------------------------------------------------
	[INFO] Running AmazonForecastServiceIntegrationTest
	Test 1 passed
	Test 2 passed
	...
	Done!

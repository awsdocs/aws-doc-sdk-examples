...
- [DownloadDirectory](src/main/java/com/example/s3/transfermanager/DownloadToDirectory.java#L6)
...
- [UploadDirectory](src/main/java/com/example/s3/transfermanager/UploadADirectory.java#L6)

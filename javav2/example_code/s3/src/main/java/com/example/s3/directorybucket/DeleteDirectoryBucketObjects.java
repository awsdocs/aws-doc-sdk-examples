...
public class DeleteDirectoryBucketObjects {
    ...
    public static void main(String[] args) {
        ...
        Path filePath1 = Paths.get("src/main/resources/directoryBucket/sample1.txt"); // path to your file
        Path filePath2 = Paths.get("src/main/resources/directoryBucket/sample2.txt"); // path to your file

...
public class FilterRecommendations {
    ...
    public static void main(String[] args) {
        ...
        // two placeholder parameters, and passes two values to the first and one to the
        // second.
        // in the GetRecommendations request.
        // Your filter may not have the same number of parameters or you may not want to
        // use two values.
        // Change the following code and the PersonalizeTest.java code based on the

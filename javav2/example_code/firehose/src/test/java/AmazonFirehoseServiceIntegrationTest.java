...
public class AmazonFirehoseServiceIntegrationTest {
    ...
    public static void setUp() throws IOException {
        ...
        try (InputStream input = AmazonFirehoseServiceIntegrationTest.class.getClassLoader().getResourceAsStream("config.properties")) {

...
public class EnhancedGetItemUsingIndex {
    ...
    public static void queryIndex(DynamoDbClient ddb, String tableName) {
        try {
            ...
            DynamoDbIndex<Movies> secIndex = enhancedClient.table("Movies", TableSchema.fromBean(Movies.class))
                    .index("year-index");
            ...
            results.forEach(page -> {
                ...
                for (Movies myMovies : allMovies) {
                    System.out.println(
                            "The movie title is " + myMovies.getTitle() + ". The year is " + myMovies.getYear());
                }
            });

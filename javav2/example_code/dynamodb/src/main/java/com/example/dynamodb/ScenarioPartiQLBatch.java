 ...
 * 5. Deletes the table.
 * <p>
 * To see another code example with more options using PartiQL, see the
 * ScenarioPartiQ code example.
 */
...
public class ScenarioPartiQLBatch {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Updating two movies with producer information: " + title1 + " and " + title2 + ".");

 ...
 *
 * If you have issues connecting, check your inbound rules that belong to the
 * security group.
 *
 * To run this example, create an Amazon Redshift cluster and then create a
 * database named dev.
 * Next, create a table named Work that contains the specific fields. For
 * details, see the Creating the

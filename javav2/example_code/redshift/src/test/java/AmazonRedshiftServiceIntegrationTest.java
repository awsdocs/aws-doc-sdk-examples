...
public class AmazonRedshiftServiceIntegrationTest {
    ...
    public static void setUp() throws IOException {
        ...
        redshiftClient = RedshiftClient.builder()
                .region(region)
                .build();
        try (InputStream input = AmazonRedshiftServiceIntegrationTest.class.getClassLoader().getResourceAsStream("config.properties")) {

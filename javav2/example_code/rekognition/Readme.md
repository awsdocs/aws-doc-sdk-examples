# Amazon Rekognition Java Readme

A README that discusses how to run and test the Java Amazon Rekognition code examples.
...
You can test the Amazon Rekognition Java code examples by running a test file named **RekognitionServiceIntegrationTest**. This file uses JUnit 5 to run the JUnit tests and is located in the **src/test/java** folder. For more information, see [https://junit.org/junit5/](https://junit.org/junit5/) .

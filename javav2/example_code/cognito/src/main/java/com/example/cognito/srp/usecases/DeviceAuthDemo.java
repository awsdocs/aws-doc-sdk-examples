...
public class DeviceAuthDemo {
    ...
    public RespondToAuthChallengeResponse deviceSrpAuth(String username, String deviceGroupKey, String deviceKey,
        ...
        RespondToAuthChallengeResponse deviceSrpChallengeResponse = respondToDeviceSrpAuthChallenge(username, deviceKey,
                A.toString(16));

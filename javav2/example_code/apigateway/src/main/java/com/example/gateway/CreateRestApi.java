//snippet-sourcedescription:[CreateRestApi.java demonstrates how to creates a new RestApi resource.]
...
public class CreateRestApi {
    ...
    public static void main(String[] args) {
        ...
        String restApiName = "RestAPI100";
        String restApiId = "inx399ewyg";
        createAPI(apiGateway, restApiId);
        apiGateway.close();
    }
    ...
    public static String createAPI( ApiGatewayClient apiGateway, String restApiId) {
        ...
        try {
            ...
            System.out.println("The id of the new method is "+response.id());
            return response.id();

...
If the text was in another language, then the text is translated back into the original language and passed back to the client where is it displayed in the Web UI. The following Java code represents the **LexService** class.

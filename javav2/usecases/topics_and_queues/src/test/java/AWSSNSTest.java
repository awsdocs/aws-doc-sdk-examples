...
public class AWSSNSTest {
        ...
        public void TestWorkflowFIFO() throws InterruptedException {
                ...
                String policy = "{\n" +
                                ...
                                "                 \"Resource\": \"arn:aws:sqs:us-east-1:" + accountId + ":"
                                + sqsQueueName + "\",\n" +
                                "                 \"Condition\": {\n" +
                                "             \"ArnEquals\": {\n" +
                                "                 \"aws:SourceArn\": \"arn:aws:sns:us-east-1:" + accountId + ":"
                                + topicName + "\"\n" +
                                "             }\n" +
                                "         }\n" +
                                "     }\n" +
                ...
                message = "Hello there";
                SNSWorkflow.pubMessageFIFO(snsClient, message, topicArn, msgAttValue, duplication, groupId,
                                deduplicationID);
                System.out.println(DASHES);

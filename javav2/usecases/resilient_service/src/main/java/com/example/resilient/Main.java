 ...
 *
 * <a href=
 * "https://docs.aws.amazon.com/sdk-for-java/latest/developer-guide/get-started.html">...</a>
 *
 * In addition, set these values:
 *
 * 1. fileName - The location of the recommendations.json (you can locate this
 * file in python/cross_service/resilient_service).
 * 2. tableName - The name of the Amazon DynamoDB table.
 * 3. startScript - The location of the server_startup_script.sh script (you can
 * locate this file in workflows/resilient_service/resources).
 * 4. policyFile - the location of the instance_policy.json (you can locate this
 * file in workflows/resilient_service/resources).
 * 5. ssmJSON - the location of the ssm_only_policy.json (you can locate this
 * file in workflows/resilient_service/resources).

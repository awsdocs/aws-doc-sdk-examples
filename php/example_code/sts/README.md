# AWS STS code examples for the SDK for PHP

## Overview

Shows how to use the AWS SDK for PHP to work with AWS Security Token Service (AWS STS).
...
- [SDK for PHP AWS STS reference](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.Sts.html)

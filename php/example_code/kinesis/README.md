# Kinesis code examples for the SDK for PHP

## Overview

Shows how to use the AWS SDK for PHP to work with Amazon Kinesis.
...
- [SDK for PHP Kinesis reference](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.Kinesis.html)

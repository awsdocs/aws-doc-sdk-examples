# Amazon RDS code examples for the SDK for PHP

## Overview

Shows how to use the AWS SDK for PHP to work with Amazon Relational Database Service (Amazon RDS).
...
- [SDK for PHP Amazon RDS reference](https://docs.aws.amazon.com/aws-sdk-php/v3/api/namespace-Aws.Rds.html)

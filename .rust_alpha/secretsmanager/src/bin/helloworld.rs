...
async fn main() {
    ...
    let config = secretsmanager::Config::builder()
        // The AWS Region can also be loaded from AWS_DEFAULT_REGION, just remove this line.
        .region(Region::new("us-east-1"))
        // Credentials can be loaded from environment variables, or they can be hard coded.
    ...
    // We need to find a better way to handle failure such as ResourceExistsException.

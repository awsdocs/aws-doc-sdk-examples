# Amazon WorkDocs code examples for the SDK for Ruby
...
- [Describe root folder contents](workdocs_basics.rb#L36) (`DescribeRootFolders`)
- [Describe users](workdocs_basics.rb#L12) (`DescribeUsers`)

...
describe LambdaWrapper do
  context "LambdaWrapper" do
    ...
    it "creates IAM role and attaches policy", integ: "true", quarantine: "true" do
    ...
    it "creates a new deployment package", integ: "true", quarantine: "true" do
      deployment_package = wrapper.create_deployment_package(source_file)
      expect(deployment_package).to be_instance_of(String)
    end

    it "creates new Lambda function", integ: "true", quarantine: "true" do
      deployment_package = wrapper.create_deployment_package(source_file)
    ...
    it "lists all Lambda functions", integ: "true", quarantine: "true" do
      response = wrapper.list_functions
      expect(response.find { |item| item == custom_name }).to_not be_nil
    end

    it "invokes the Lambda function", integ: "true", quarantine: "true" do
      payload = { number: "2" }
    ...
    it "updates the Lambda function configuration", integ: "true", quarantine: "true" do
    ...
    it "updates Lambda function code", integ: "true", quarantine: "true" do
    ...
    it "deletes Lambda function", integ: "true", quarantine: "true" do
      wrapper.delete_function(custom_name)
    end

    it "deletes IAM role", integ: "true", quarantine: "true" do

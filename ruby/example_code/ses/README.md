# SES code examples for the AWS SDK for Ruby (v3)
## Overview
These examples show how to create and manage Amazon Simple Email Service (Amazon SES) domains using the AWS SDK for Ruby (v3).

# snippet-sourcedescription:[MoviesScan.rb demonstrates how to ]
...
# snippet-start:[dynamodb.ruby.code_example.movies_scan] 
...
# snippet-end:[dynamodb.ruby.code_example.movies_scan]

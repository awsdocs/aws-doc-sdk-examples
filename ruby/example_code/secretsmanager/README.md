# SecretsManager code examples for the AWS SDK for Ruby
## Overview
These examples show how to create and manage secrets in AWS Secrets Manager using the AWS SDK for Ruby.

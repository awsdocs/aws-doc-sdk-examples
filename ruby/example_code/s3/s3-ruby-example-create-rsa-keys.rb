...
# Purpose
# This code example demonstrates how to create a public and private key file pair.

# snippet-start:[s3.ruby.s3-ruby-example-create-rsa-keys]
...
# snippet-end:[s3.ruby.s3-ruby-example-create-rsa-keys]

# TypeScript environment for AWS Simple Notification Service (SNS) examples
This is a workspace where you can find working AWS SDK for JavaScript version 3 (v3) AWS SNS examples.
...
AWS SNS is a fully managed messaging service for both system-to-system and app-to-person (A2P) communication. 

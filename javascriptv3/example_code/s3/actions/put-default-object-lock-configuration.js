...
export const main = async (client, bucketName) => {
  // snippet-start:[s3.JavaScript.buckets.putDefaultObjectLockConfigurationV3]
  ...
  try {
    ...
    console.log(
      `Default Object Lock Configuration updated: ${response.$metadata.httpStatusCode}`
    );
  } catch (err) {
    console.error(err);
  }
  // snippet-end:[s3.JavaScript.buckets.putDefaultObjectLockConfigurationV3]
};

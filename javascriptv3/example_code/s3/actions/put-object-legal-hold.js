...
export const main = async (client, bucketName, objectKey) => {
  // snippet-start:[s3.JavaScript.buckets.putObjectLegalHoldV3]
  ...
  try {
    ...
    console.log(`Object legal hold status: ${response.$metadata.httpStatusCode}`);
  } catch (err) {
    console.error(err);
  }
  // snippet-end:[s3.JavaScript.buckets.putObjectLegalHoldV3]
};

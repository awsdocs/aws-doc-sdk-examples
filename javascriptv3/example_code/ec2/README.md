# TypeScript environment for AWS Elastic Computing (AWS EC2) examples
This is a workspace where you can find working AWS SDK for JavaScript version 3 (v3) AWS EC2 examples. 

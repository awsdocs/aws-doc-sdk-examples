    ...
    <div className="card">
      ...
      <form>
        <div className="form-text">
          Load an image file from Amazon S3, then select Extract to explore image data.
        </div>
        <div className="mb-3">
          <label htmlFor="imageBucket">Bucket</label>
          <input
            type="text" className="form-control" id="imageBucket"
            value={imageBucket}
        ...
        <div className="mb-3">
          ...
          <input type="text" className="form-control" id="imageKey"
            value={imageKey}
        ...
        <div className={`alert alert-danger ${props.modelError ? '' : 'visually-hidden'}`}
          role="status">
          {props.modelError}
        </div>
      </form>

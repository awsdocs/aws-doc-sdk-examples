# Build and manage a resilient service using the SDK for JavaScript

## Overview

This example shows how to use the AWS SDK for JavaScript (v3) to create a load-balanced
...
Each of these components is created and managed with the SDK for JavaScript as part of
...
Use the SDK for JavaScript to create the following AWS resources:
...
Use the SDK for JavaScript to clean up all resources created for this example.
...
- [SDK for JavaScript Elastic Load Balancing v2 reference](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/elastic-load-balancing-v2/)
- [SDK for JavaScript Amazon EC2 Auto Scaling reference](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/auto-scaling/)
- [SDK for JavaScript Amazon EC2 reference](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/ec2/)

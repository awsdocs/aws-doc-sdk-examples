...
// SPDX-License-Identifier:  Apache-2.0
    ...
    /// <summary>
    /// Shows how to create a new Amazon Key Management Service (AWS KMS)
...
namespace CreateKeyExample
{
    ...
    public class CreateKey
    {
        ...
        {
            // Note that if you need to create a Key that in an Amazon Region
            // other than the region defined for the default user, you need to
            // pass the regsion to the client constructor.

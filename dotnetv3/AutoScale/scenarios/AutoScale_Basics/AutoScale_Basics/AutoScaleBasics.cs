...
await AutoScaleMethods.CreateAutoScalingGroup(
    autoScalingClient,
    groupName,
    launchTemplateName,
...
Console.WriteLine("Wait 2 min for the resources, including the instance. Otherwise,");
Console.WriteLine("an empty instance Id is returned");
...
var activities = await AutoScaleMethods.DescribeScalingActivities(autoScalingClient, groupName);

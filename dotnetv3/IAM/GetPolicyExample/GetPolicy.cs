...
// This example shows how to get information about an Amazon Identity Service
// policy given the Amazon Resource Name (ARN) of the IAM policy. The example
// was created using the AWS SDK for .NET 3.7 and .NET Core 5.

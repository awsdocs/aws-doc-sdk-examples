...
namespace SSEClientEncryptionExample
{
    ...
    public class SSEClientEncryption
    {
        ...
        /// <param name="keyName">The name of the object to upload to the S3
        /// bucket.</param>
        ...
        /// <summary>
        /// Downloads an encrypted object from an S3 bucket.
        /// </summary>
        /// <param name="client">The initialized S3 client object used to call
        /// GetObjectAsync.</param>
        /// <param name="bucketName">The name of the S3 bucket where the object
        /// is located.</param>
        /// <param name="keyName">The name of the S3 object to download.</param>
        ...
        /// <summary>
        /// Retrieves the metadata associated with an S3 object.
        /// </summary>
        /// <param name="client">The initialized S3 client object used to call
        ...
        /// <summary>
        /// Copies an encrypted object from one S3 bucket to another.
        /// </summary>
        /// <param name="client">The initialized S3 client object used to call

...
namespace ServerAccessLoggingExample
{
    ...
    public class ServerAccessLogging
    {
        ...
        /// </summary>
        /// <param name="client">The initialized S3 client which will be used
        ...
        /// <summary>
        /// This method enables logging for an S3 bucket. Logs will be stored
        /// in the bucket you selected for logging. Each the logObjectKeyPrefix
        /// will be prepended to each log oject.
        /// </summary>
        /// <param name="client">The initialized S3 client which will be used
        /// to configure and apply logging to the selected S3 bucket.</param>
        /// <param name="bucketName">The name of the S3 bucket for which you
        /// wish to enable logging.</param>
        /// <param name="logBucketName">The name of the S3 bucket where logging
        /// information will be stored.</param>

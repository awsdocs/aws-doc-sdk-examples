...
namespace DeleteObjectVersionExample
{
    ...
    public class DeleteObjectVersion
    {
        public static async Task Main()
        {
            ...
            // region of the S3 bucket, pass the bucket region to the S3 client
            // object's constructor. Define it like this:
        ...
        /// <param name="bucketName">The name of the S3 bucket where the will
        ...
        /// <summary>
        /// This method is used to create the temporary S3 object.
        /// </summary>
        /// <param name="client">The initialized S3 object which will be used
        /// to create the temporary S3 object.</param>
        /// <param name="bucketName">The name of the S3 bucket where the object
        /// will be created.</param>
        /// <param name="objectKey">The name of the S3 object co create.</param>

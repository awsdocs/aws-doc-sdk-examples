...
public class JobStatusNotificationsSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SqsQueueNotificationWorker sqsQueueNotificationWorker = new SqsQueueNotificationWorker(amazonSqs,
                SQS_QUEUE_URL);
     ...
     */
    private static void waitForJobToComplete(final String jobId, SqsQueueNotificationWorker sqsQueueNotificationWorker)
            throws InterruptedException {

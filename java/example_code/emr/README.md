# Amazon EMR code examples for the SDK for Java 1.x
...
Shows how to use the AWS SDK for Java 1.x to work with Amazon EMR.
...
- [SDK for Java 1.x Amazon EMR reference](https://sdk.amazonaws.com/java/api/latest/software/amazon/awssdk/services/emr/package-summary.html)

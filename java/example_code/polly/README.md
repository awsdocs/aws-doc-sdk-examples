# Amazon Polly code examples for the SDK for Java 1.x
...
Shows how to use the AWS SDK for Java 1.x to work with Amazon Polly.
...
- [Get voices available for synthesis](None) (`DescribeVoices`)
- [List pronunciation lexicons](None) (`ListLexicons`)
- [Synthesize speech from text](None) (`SynthesizeSpeech`)
...
- [SDK for Java 1.x Amazon Polly reference](https://sdk.amazonaws.com/java/api/latest/software/amazon/awssdk/services/polly/package-summary.html)

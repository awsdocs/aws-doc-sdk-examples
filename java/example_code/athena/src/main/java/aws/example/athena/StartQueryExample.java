 ...
 * StartQueryExample
 * -------------------------------------
 * This code shows how to submit a query to Athena for execution, wait till
 * results
...
public class StartQueryExample {
     ...
     * by polling Athena over an
     * interval of time. If a query fails or is cancelled, then it will throw an
     * exception.
     */

    private static void waitForQueryToComplete(AmazonAthena athenaClient, String queryExecutionId)
     ...
     * The query must be in a completed state before the results can be retrieved
     * and

...
// snippet-start:[s3.go-v2.create_bucket.imports]
import (
	"context"
	"flag"
	"fmt"
...
// snippet-end:[s3.go-v2.create_bucket.imports]

// S3CreateBucketAPI defines the interface for the CreateBucket function.
// snippet-start:[s3.go-v2.CreateBucket.interface]
...
// snippet-end:[s3.go-v2.CreateBucket.interface]
...
func main() {
	// snippet-start:[s3.go-v2.CreateBucket.args]
	...
	// snippet-end:[s3.go-v2.CreateBucket.args]

	// snippet-start:[s3.go-v2.CreateBucket.configclient]
	...
	// snippet-end:[s3.go-v2.CreateBucket.configclient]

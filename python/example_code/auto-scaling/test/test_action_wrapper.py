...
def test_create_group(make_stubber, error_code):
    ...
    if error_code is None:
        wrapper.create_group(
            group_name, zones, launch_template_name, min_size, max_size
        )
    else:
...
def test_update_group(make_stubber, error_code):
    ...
    autoscaling_stubber.stub_update_auto_scaling_group(
        group_name, min_size, max_size, error_code=error_code
    )
...
def test_set_desired_capacity(make_stubber, error_code):
    ...
    autoscaling_stubber.stub_set_desired_capacity(
        group_name, capacity, error_code=error_code
    )
...
def test_describe_instances(make_stubber, error_code):
    ...
    autoscaling_stubber.stub_describe_auto_scaling_instances(
        instance_ids, instances, error_code=error_code
    )
...
def test_describe_scaling_activities(make_stubber, error_code):
    ...
    autoscaling_stubber.stub_describe_scaling_activities(
        group_name, activities, error_code=error_code
    )
...
def test_disable_metrics(make_stubber, error_code):
    ...
    autoscaling_stubber.stub_disable_metrics_collection(
        group_name, error_code=error_code
    )

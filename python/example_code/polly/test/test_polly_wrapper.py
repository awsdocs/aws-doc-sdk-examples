...
@pytest.mark.parametrize(
    "include_visemes,error_code,stop_on_method",
    [
        (True, None, None),
        (False, None, None),
...
def test_do_synthesis_task(
    ...
    with stub_runner(error_code, stop_on_method) as runner:
        runner.add(
            polly_stubber.stub_start_speech_synthesis_task,
            text,
            engine,
            voice,
            "mp3",
        ...
        runner.add(
            polly_stubber.stub_get_speech_synthesis_task,
            speech_task_id,
            bucket,
            key,
            status,

...
bucket.\n
    """
        ...
        # $ec2Choice = testable_readline(
        #     "Are you running this in an EC2 instance located in the same AZ as your intended Directory buckets? Enter Y/y to setup a VPC Endpoint, or N/n/blank to skip this section.");
        ...
        print("\n")
        print("3. Create an additional client using the credentials with S3 Express permissions.\n")
        print(
        ...
        print("Now we will create a Directory bucket, which is the linchpin of the S3 Express One Zone service.\n")
        print("Directory buckets behave in different ways from regular S3 buckets, which we will explore here.\n")
        print(
            "We'll also create a normal bucket, put an object into the normal bucket, and copy it over to the Directory bucket.\n")
        q.ask("Press Enter to continue...")
        print("Now, let's create the actual Directory bucket, as well as a regular bucket.\n")
        q.ask("Press Enter to continue...")
        print("Great! Both buckets were created.\n")
        q.ask("Press Enter to continue...")
        print("\n")
        print("5. Create an object and copy it over.\n")
        print("We'll create a basic object consisting of some text and upload it to the normal bucket.\n")
        print("Next, we'll copy the object into the Directory bucket using the regular client.\n")
        print("This works fine, because Copy operations are not restricted for Directory buckets.\n")
        q.ask("Press Enter to continue...")
        print("It worked! It's important to remember the user permissions when interacting with Directory buckets.\n")
        print(
        ...
        print("The directory bucket took $directoryTimeDiff nanoseconds, while the normal bucket took $normalTimeDiff.\n")
        ...
        print("Now let's explore how Directory buckets store objects in a different manner to regular buckets.\n")
        ...
        print("This allows for more rapid indexing, traversing, and therefore retrieval times!\n")
        print(
            "The more segmented your bucket is, with lots of directories, sub-directories, and objects, the more efficient it becomes.\n")
        print("This structural difference also causes ListObjects to behave differently, which can cause unexpected results.\n")
        print("Let's add a few more objects with layered directories as see how the output of ListObjects changes.\n")
        q.ask("Press Enter to continue...")
    ...
    def cleanup(self):
        ...
        print("There was a problem deleting some resources. The following keys are still set: \n")
...
if __name__ == "__main__":
    ...
    try:
        ...
        s3_express_scenario = S3ExpressScenario(cloud_formation_resource)

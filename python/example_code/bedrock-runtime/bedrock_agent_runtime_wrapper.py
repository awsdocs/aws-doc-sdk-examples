...
# snippet-start:[python.example_code.bedrock-runtime.BedrockAgentRuntimeWrapper.class]
...
class BedrockAgentRuntimeWrapper:
    ...
    # snippet-start:[python.example_code.bedrock-agents-runtime.InvokeAgent]

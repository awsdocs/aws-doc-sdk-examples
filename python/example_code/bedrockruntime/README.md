...
Shows how to use the AWS SDK for Python (Boto3) to work with the Amazon Bedrock Runtime client.
...
* [Invoking foundation models](bedrock_runtime_wrapper.py#L35) (`InvokeModel`)
...
This example demonstrates the invocation of Anthropic Claude 2 and AI21 Labs Jurassic-2.

Start it by running the following at a command prompt:
...
* [AWS SDK for Python - Amazon Bedrock Runtime client reference](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-runtime.html)

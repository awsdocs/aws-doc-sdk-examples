...
class MockManager:
    def __init__(self, stub_runner, scenario_data, input_mocker):
        ...
        self.act_arn = f'arn:aws:states:test-region:111122223333:/activity/{self.act_name}'
        self.sm_role = 'test-role'
        self.scenario_args = [self.sm_name, self.sm_arn, self.act_name, self.act_arn, self.sm_role]
        answers = ['y']

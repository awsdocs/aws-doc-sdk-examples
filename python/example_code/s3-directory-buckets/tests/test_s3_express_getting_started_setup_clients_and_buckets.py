...
class MockManager:
    def __init__(self, stub_runner, scenario_data, input_mocker):
        ...
        self.availability_zone_filter = [
            {"Name": "region-name", "Values": [self.scenario_data.region]}
        ]
        ...
        self.directory_bucket_configuration = {
            ...
            "Location": {
                "Name": self.availability_zone_ids[0],
    ...
    def setup_stubs(
        self, error, stop_on, ec2_stubber, iam_stubber, s3_stubber, monkeypatch
    ):
        ...
        monkeypatch.setattr(
            ...
            "create_s3__client_with_access_key_credentials",
...
@pytest.mark.integ
def test_scenario_setup_clients_and_buckets(mock_mgr, capsys, monkeypatch):
    ...
    mock_mgr.scenario_data.scenario.setup_clients_and_buckets(
        mock_mgr.express_user_name, mock_mgr.regular_user_name
    )
...
@pytest.mark.integ
def test_scenario_setup_clients_and_buckets_error(

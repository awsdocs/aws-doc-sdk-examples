...
# snippet-sourcedescription:[camera.py demonstrates how to mock an AWS IoT Things Graph camera device in an AWS IoT Greengrass group.]
...
# snippet-start:[iotthingsgraph.python.camera.complete]
...
# snippet-end:[iotthingsgraph.python.camera.complete]
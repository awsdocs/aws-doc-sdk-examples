...
def main():
    ...
    # useful partition key, resulting in all the records in a particular
    # "sector" to be stored on the same shard. Note: Because the example
    # uses only a single shard, the partition key has no effect, but it is
    # still required.

...
@pytest.mark.parametrize(
    "job_slice,error_code",
    [((0, 10), None), ((0, 5), None), ((0, 10), "TestException")],
)
...
@pytest.mark.parametrize(
    "phrases,error_code", [(True, None), (False, None), (True, "TestException")]
)

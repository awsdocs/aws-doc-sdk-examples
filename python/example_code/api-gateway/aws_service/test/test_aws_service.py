...
def test_add_integration_method(make_stubber, stub_runner, error_code, stop_on_method):
    ...
    with stub_runner(error_code, stop_on_method) as runner:
        runner.add(
            apigateway_stubber.stub_put_method,
            api_gtos.api_id,
            resource_id,
            http_method=rest_method,
        )
        runner.add(
            apigateway_stubber.stub_put_method_response,
            api_gtos.api_id,
            resource_id,
        ...
        runner.add(
            apigateway_stubber.stub_put_integration,
            api_gtos.api_id,
            resource_id,
            service_uri,
            http_method=rest_method,
            integ_type="AWS",
            integ_method=service_method,
            integ_role_arn=role_arn,
            integ_templates=mapping_template,
            passthrough="WHEN_NO_TEMPLATES",
        )
        runner.add(
            apigateway_stubber.stub_put_integration_response,
            api_gtos.api_id,
            resource_id,
            {"application/json": ""},
            http_method=rest_method,
...
def test_get_rest_api_id(make_stubber, error_code):
    ...
    api_ids = [
        {"id": f"test-api-id-{index}", "name": f"test-api_name-{index}"}

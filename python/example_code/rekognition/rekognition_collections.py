...
class RekognitionCollection:
    ...
    def describe_collection(self):
        ...
        try:
            ...
            logger.exception(
                "Couldn't get data for collection %s.",
                self.collection_id)
            raise
        else:
            return self.to_dict()
    ...
    def delete_collection(self):
        ...
        """
        try:
            self.rekognition_client.delete_collection(
                CollectionId=self.collection_id)
    ...
    def index_faces(self, image, max_faces):
        ...
        try:
            ...
            logger.exception(
                "Couldn't index faces in image %s.",
                image.image_name)
            raise
        else:
    ...
    def search_faces_by_image(self, image, threshold, max_faces):
        ...
        try:
            ...
            collection_faces = [
                RekognitionFace(
                    face["Face"]) for face in response["FaceMatches"]]
            logger.info(
    ...
    def search_faces(self, face_id, threshold, max_faces):
        ...
        try:
            ...
            faces = [RekognitionFace(face["Face"])
    ...
    def delete_faces(self, face_ids):
        ...
        try:
            ...
            logger.info(
                "Deleted %s faces from %s.",
                len(deleted_ids),
                self.collection_id)
        except ClientError:
            logger.exception(
                "Couldn't delete faces from %s.",
                self.collection_id)
            raise
        else:
            return deleted_ids
    ...
    def create_collection(self, collection_id):
        ...
        try:
            ...
            collection = RekognitionCollection(
                response, self.rekognition_client)

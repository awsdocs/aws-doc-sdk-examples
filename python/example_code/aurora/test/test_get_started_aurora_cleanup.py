...
class MockManager:
    ...
    def setup_stubs(self, error, stop_on, stubber):
        with self.stub_runner(error, stop_on) as runner:
            ...
            runner.add(
                stubber.stub_delete_db_cluster, self.cluster["DBClusterIdentifier"]
            )
            runner.add(
            ...
            runner.add(
                ...
                self.cluster["DBClusterIdentifier"],
                error_code="DBClusterNotFoundFault",
            )
            runner.add(
                stubber.stub_delete_db_cluster_parameter_group,
                self.group["DBClusterParameterGroupName"],
            )

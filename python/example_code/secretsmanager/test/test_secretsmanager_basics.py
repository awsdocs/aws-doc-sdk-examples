...
@pytest.mark.parametrize(
    "secret_value,error_code",
    [("test-secret", None), (b"test-secret", None), ("test-secret", "TestException")],
)
...
@pytest.mark.parametrize(
    "name,error_code",
    [("test-name", None), (None, None), ("test-name", "TestException")],
)
...
@pytest.mark.parametrize(
    "secret_value,stages,error_code",
    [

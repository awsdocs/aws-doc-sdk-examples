...
#snippet-sourcedescription:[Accesses the current version of a secret on the core. https://docs.aws.amazon.com/greengrass/latest/developerguide/secrets-using.html ]

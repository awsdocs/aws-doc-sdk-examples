...
#snippet-sourcedescription:['Hello World Counter' Lambda function sends MQTT messages. https://docs.aws.amazon.com/greengrass/latest/developerguide/module3-II.html ]

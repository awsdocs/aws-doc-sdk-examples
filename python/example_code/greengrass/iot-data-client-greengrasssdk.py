...
#snippet-sourcedescription:[Instantiates the iot-data client from the AWS IoT Greengrass Core SDK. https://docs.aws.amazon.com/greengrass/latest/developerguide/lambda-functions.html#lambda-migrate-sdks ]

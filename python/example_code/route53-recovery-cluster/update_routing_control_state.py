...
def update_routing_control_state(routing_control_arn, routing_control_state, cluster_endpoints):
	for cluster_endpoint in cluster_endpoints:
		try:
			...
			response = client.update_routing_control_state(RoutingControlArn=args.routing_control_arn, RoutingControlState=args.routing_control_state)

...
class SESv2Workflow:
    ...
    def prepare_application(self):
        ...
        # snippet-start:[python.example_code.sesv2.CreateContactList]
        try:
            ...
            if e.response["Error"]["Code"] == "AlreadyExistsException":
                ...
                raise e
        # snippet-end:[python.example_code.sesv2.CreateContactList]
    ...
    def gather_subscriber_email_addresses(self):
        ...
        for email in email_variants:
            # snippet-start:[python.example_code.sesv2.CreateContact]
            try:
                ...
                # snippet-start:[python.example_code.sesv2.SendEmail.simple]
                ...
                # snippet-end:[python.example_code.sesv2.SendEmail.simple]
                if self.sleep:
                ...
                if e.response["Error"]["Code"] == "AlreadyExistsException":
                    ...
                    raise e
            # snippet-end:[python.example_code.sesv2.CreateContact]
    ...
    def send_coupon_newsletter(self):
        ...
        # snippet-start:[python.example_code.sesv2.ListContacts]
        try:
            ...
            if e.response["Error"]["Code"] == "NotFoundException":
                ...
                raise e
        # snippet-end:[python.example_code.sesv2.ListContacts]
...
"""
    ...
    def clean_up(self):
        ...
        # snippet-start:[python.example_code.sesv2.DeleteContactList]
        try:
            ...
            if e.response["Error"]["Code"] == "NotFoundException":
                ...
                print(e)
        # snippet-end:[python.example_code.sesv2.DeleteContactList]

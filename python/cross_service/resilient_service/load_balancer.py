...
class LoadBalancer:
    ...
    def __init__(
            self, target_group_name, load_balancer_name, elb_client):
        """
    ...
    def create_target_group(self, protocol, port, vpc_id):
        ...
        try:
            response = self.elb_client.create_target_group(
                Name=self.target_group_name, Protocol=protocol, Port=port,
                HealthCheckPath='/healthcheck', HealthCheckIntervalSeconds=10,
                HealthCheckTimeoutSeconds=5, HealthyThresholdCount=2,
                UnhealthyThresholdCount=2, VpcId=vpc_id)
    ...
    def create_load_balancer(self, subnet_ids, target_group):
        ...
        try:
            ...
            log.info(
                ...
                self.load_balancer_name, target_group['TargetGroupName'])
        except ClientError as err:
            raise LoadBalancerError(

...
class ScenarioData:
    def __init__(self, auto_scaling, elb, ddb, ec2, ssm, iam):
        ...
        self.instance = {
            'InstanceId': 'test-instance-id', 'AvailabilityZone': 'test-zone', 'LifecycleState': 'active',
            'HealthStatus': 'healthy', 'ProtectedFromScaleIn': True}
        ...
        self.lb_arn = 'arn:aws:elasticloadbalancing:test-region:123456789012:loadbalancer/test-lb'
        self.bad_policy_arn = 'arn:aws:iam:us-west-2:123456789012:policy/test-bad-policy'
        ...
        self.scenario = runner.Runner(
            ...
            AutoScaler(
                self.resource_prefix, self.inst_type, self.ami_param,
                self.auto_scaling.client, self.ec2.client, self.ssm.client, self.iam.client),

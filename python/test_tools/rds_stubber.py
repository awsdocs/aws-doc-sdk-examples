...
class RdsStubber(ExampleStubber):
    ...
    def stub_describe_db_cluster_parameter_groups(
        self, group_name, groups, error_code=None
    ):
        expected_params = {"DBClusterParameterGroupName": group_name}
    ...
    def stub_describe_db_engine_versions(
        self, engine, versions, param_family=None, error_code=None
    ):
    ...
    def stub_describe_db_cluster_parameters(
        self, group_name, params, source=None, error_code=None
    ):
        expected_params = {"DBClusterParameterGroupName": group_name}
    ...
    def stub_modify_db_cluster_parameter_group(
        self, group_name, parameters, error_code=None
    ):
        expected_params = {
            "DBClusterParameterGroupName": group_name,
    ...
    def stub_describe_db_instances(self, instance_id, error_code=None):
        ...
        response = {
            "DBInstances": [
                {"DBInstanceIdentifier": instance_id, "DBInstanceStatus": "available"}
            ]
        }
        self._stub_bifurcator(
    ...
    def stub_describe_db_cluster_snapshots(self, snapshot_id, error_code=None):
        ...
        response = {
            "DBClusterSnapshots": [
                {"DBClusterSnapshotIdentifier": snapshot_id, "Status": "available"}
            ]
        }
        self._stub_bifurcator(
    ...
    def stub_create_db_parameter_group(
        self, group_name, group_family, desc, error_code=None
    ):
        expected_params = {
    ...
    def stub_describe_db_parameters(
        self, group_name, params, source=None, error_code=None
    ):
        expected_params = {"DBParameterGroupName": group_name}
        if source is not None:
    ...
    def stub_describe_db_snapshots(self, snapshot_id, error_code=None):
        ...
        response = {
            "DBSnapshots": [
                {"DBSnapshotIdentifier": snapshot_id, "Status": "available"}
            ]
        }
        self._stub_bifurcator(

...
class LookoutVisionStubber(ExampleStubber):
    ...
    def stub_list_dataset_entries(
        self, project_name, dataset_type, jsonline, error_code=None
    ):
        expected_params = {
            "ProjectName": project_name,
            "DatasetType": dataset_type,
    ...
    def stub_describe_model(
        ...
        if extras is not None:
            ...
            desc["OutputConfig"] = {
                "S3Location": {
                    "Bucket": extras["out_bucket"],
                    "Prefix": extras["out_folder"],
                }
            }
        self._stub_bifurcator(
    ...
    def stub_create_model(
        ...
        expected_params = {
            "ProjectName": project_name,
            "OutputConfig": {
                "S3Location": {"Bucket": out_bucket, "Prefix": out_folder}
            },
            "Tags": [],
        }
        response = {

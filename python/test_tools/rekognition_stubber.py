...
class RekognitionStubber(ExampleStubber):
            ...
            face_dict.update(
                {
                    ...
                    "Emotions": [
                        {"Type": emotion, "Confidence": 80} for emotion in face.emotions
                    ],
                }
            )
        return face_dict
    ...
    def stub_compare_faces(
        ...
        response = {
            "FaceMatches": [
                {"Similarity": similarity, "Face": self._face_to_dict(match)}
    ...
    def stub_index_faces(
        ...
        response = {
            ...
            "UnindexedFaces": [
                {"FaceDetail": self._face_to_dict(face)} for face in unindexed_faces
            ],
        }
        self._stub_bifurcator(
    ...
    def stub_get_label_detection(self, job_id, job_status, labels, error_code=None):
        ...
        response = {
            ...
            "Labels": [
                {"Timestamp": label.timestamp, "Label": self._label_to_dict(label)}
                for label in labels
            ],
        }
        self._stub_bifurcator(
    ...
    def stub_get_face_detection(self, job_id, job_status, faces, error_code=None):
        ...
        response = {
            "JobStatus": job_status,
            "Faces": [
                {"Timestamp": face.timestamp, "Face": self._face_to_dict(face)}
                for face in faces
            ],
        }
        self._stub_bifurcator(
    ...
    def stub_get_person_tracking(self, job_id, job_status, persons, error_code=None):
        ...
        response = {
            "JobStatus": job_status,
            "Persons": [
                {"Timestamp": person.timestamp, "Person": self._person_to_dict(person)}
            ...
            "Celebrities": [
                {
                    ...
                    "Celebrity": self._celebrity_to_dict(celebrity),
                }

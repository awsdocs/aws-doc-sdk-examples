# CodeBuild code examples for the SDK for Go V1
...
Shows how to use the AWS SDK for Go V1 to work with AWS CodeBuild.
...
- [SDK for Go V1 CodeBuild reference](https://pkg.go.dev/github.com/aws/aws-sdk-go/service/codebuild)

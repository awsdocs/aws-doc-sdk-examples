# Amazon SQS code examples for the SDK for Go V1
...
Shows how to use the AWS SDK for Go V1 to work with Amazon Simple Queue Service (Amazon SQS).
...
- [SDK for Go V1 Amazon SQS reference](https://pkg.go.dev/github.com/aws/aws-sdk-go/service/sqs)

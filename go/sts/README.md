# AWS STS code examples for the SDK for Go V1
...
Shows how to use the AWS SDK for Go V1 to work with AWS Security Token Service (AWS STS).
...
- [SDK for Go V1 AWS STS reference](https://pkg.go.dev/github.com/aws/aws-sdk-go/service/sts)

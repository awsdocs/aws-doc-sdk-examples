# Amazon Polly code examples for the SDK for Kotlin

## Overview

Shows how to use the AWS SDK for Kotlin to work with Amazon Polly.
...
- [SDK for Kotlin Amazon Polly reference](https://sdk.amazonaws.com/kotlin/api/latest/polly/index.html)

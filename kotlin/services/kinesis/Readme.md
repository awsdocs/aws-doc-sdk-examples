# Kinesis code examples for the SDK for Kotlin

## Overview

Shows how to use the AWS SDK for Kotlin to work with Amazon Kinesis.
...
- [SDK for Kotlin Kinesis reference](https://sdk.amazonaws.com/kotlin/api/latest/kinesis/index.html)

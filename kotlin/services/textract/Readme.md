# Amazon Textract code examples for the SDK for Kotlin

## Overview

Shows how to use the AWS SDK for Kotlin to work with Amazon Textract.
...
- [SDK for Kotlin Amazon Textract reference](https://sdk.amazonaws.com/kotlin/api/latest/textract/index.html)

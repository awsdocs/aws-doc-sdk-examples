# Amazon SES code examples for the SDK for Kotlin

## Overview

Shows how to use the AWS SDK for Kotlin to work with Amazon Simple Email Service (Amazon SES).
...
- [SDK for Kotlin Amazon SES reference](https://sdk.amazonaws.com/kotlin/api/latest/ses/index.html)

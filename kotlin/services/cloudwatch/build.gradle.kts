...
dependencies {
    implementation("aws.sdk.kotlin:cloudwatch:1.3.112")
    implementation("aws.sdk.kotlin:cloudwatchevents:1.3.112")
    implementation("aws.sdk.kotlin:cloudwatchlogs:1.3.112")

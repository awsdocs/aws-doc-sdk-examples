# Amazon Translate code examples for the SDK for Kotlin

## Overview

Shows how to use the AWS SDK for Kotlin to work with Amazon Translate.
...
- [SDK for Kotlin Amazon Translate reference](https://sdk.amazonaws.com/kotlin/api/latest/translate/index.html)

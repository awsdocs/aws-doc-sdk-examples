...
import com.kotlin.sage.transformJob
...
class SageMakerTest {
    ...
    @Test
    @Order(1)
    fun createModelTest() = runBlocking {
    ...
    @Test
    @Order(3)
    fun describeTrainingJobTest() = runBlocking {
    ...
    @Test
    @Order(4)
    fun listModelsTest() = runBlocking {
        listAllModels()
    ...
    @Test
    @Order(5)
    fun listNotebooksTest() = runBlocking {
        listBooks()
    ...
    @Test
    @Order(6)
    fun ListAlgorithmsTest() = runBlocking {
        listAlgs()
    ...
    @Test
    @Order(7)
    fun listTrainingJobsTest() = runBlocking {
        listJobs()
    ...
    @Test
    @Order(8)
    fun deleteModelTest() = runBlocking {

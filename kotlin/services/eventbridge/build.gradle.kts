...
dependencies {
    implementation("aws.sdk.kotlin:eventbridge-jvm:0.33.1-beta")
    implementation("aws.sdk.kotlin:iam-jvm:0.33.1-beta")
    implementation("aws.sdk.kotlin:sns-jvm:0.33.1-beta")
    implementation("aws.sdk.kotlin:s3-jvm:0.33.1-beta")

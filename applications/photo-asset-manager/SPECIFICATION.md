...
Refer to [README.md](../tree/main/resources/cdk/photo_asset_manager/README.md) for deployment instructions and [DEVELOPMENT.md](../tree/main/applications/photo-asset-manager/DEVELOPMENT.md) for instructions on modifying the AWS CDK script.
...
- [In-Repo README for adding a new Lambda](https://github.com/awsdocs/aws-doc-sdk-examples/tree/main/applications/photo-asset-manager/DEVELOPMENT.md)

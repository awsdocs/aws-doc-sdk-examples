...
Returns a string representing the key of the synthesized audio file. This key will be sent to the
frontend. The frontend will use the key to directly get the audio file from S3.

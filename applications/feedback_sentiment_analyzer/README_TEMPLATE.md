# Creating a feedback sentiment analyzer using the SDK for LANGUAGE

## Overview

| Heading         | Description                                                                                                                                                                                                           |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Description     | Discusses how to develop a feedback sentiment analyzer application that lets a user upload images with text to be translated and converted to audio. This application is developed by using the AWS SDK for LANGUAGE. |
...
For a more thorough explanation of this example see the application [README.md](/applications/feedback_sentiment_analyzer/README.md).

### Topics

- [Prerequisites](#prerequisites)
- [Understand the photo asset management application](#understand-the-aws-resources-used-by-the-pam-application)

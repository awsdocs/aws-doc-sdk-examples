<<<<<<< HEAD:lambda_functions/secretsmanager/RDSSQLServer-Multiuser.py
...
def apply_database_permissions(cursor, current_user, pending_user):
    ...
    for row in cursor.fetchall():
        ...
        # Execute the sql
        cursor.execute(sql_stmt)
>>>>>>> ea7e8cc8... moved all examples into example_code child folder per standard:lambda_functions/example_code/secretsmanager/RDSSQLServer-Multiuser.py

<<<<<<< HEAD:lambda_functions/secretsmanager/RDSSQLServer-Singleuser.py
...
def get_secret_dict(service_client, arn, stage, token=None):
    ...
    # Parse and return the secret JSON string
    return secret_dict
>>>>>>> ea7e8cc8... moved all examples into example_code child folder per standard:lambda_functions/example_code/secretsmanager/RDSSQLServer-Singleuser.py

...
arg_parser.add_argument('--root', default='../', help='Root path for rustv1 cargos. Default ../ assumes running this script from its location in tools. Update single examples by setting root to their folder directly.')
